const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"assets/Home-_sYUadsn.js",
			"assets/asyncToGenerator-COJlnFvb.js",
			"assets/_plugin-vue_export-helper-DOrAluW7.js",
			"assets/Home-B2MLu6j4.css",
			"assets/Login-CJLaZqwg.js",
			"assets/VehicleMap-B7d-fsYW.js",
			"assets/VehicleMap-BZj50_Gp.css",
		])
) => i.map((i) => d[i]);
import {
	B as e,
...
import { t as ie } from "./debounce-dtZa6gl9.js";
import { n as j, t as ae } from "./_plugin-vue_export-helper-DOrAluW7.js";
import {
	i as oe,
	k as se,
	n as ce,
...
function de(e) {
	...
	if (!t.url) throw Error(`[request] options.url is required`);
	...
	if (t.params)
		if (t.method === `GET`) {
			...
			for (let n in t.params) e.append(n, t.params[n]);
			n = t.url + `?` + e.toString();
		} else r = JSON.stringify(t.params);
	return fetch(n, { method: t.method || `GET`, headers: t.headers, body: r })
		.then((e) => {
			if (t.transformResponse) return t.transformResponse(e, t);
			if (e.status >= 200 && e.status < 300)
				return t.responseType === `json` ? e.json() : e;
			{
				let t = Error(e.statusText);
				throw ((t.response = e), t);
			}
		})
		.catch((e) => {
			if (t.transformError) return t.transformError(e);
			throw e;
		});
}
function M(e) {
...
var N;
function pe() {
	return N || (N = fe(`keyval-store`, `keyval`)), N;
}
function me(e, t = pe()) {
...
function F(e, t) {
	...
	if (e.cache) {
		n = Ce(e.cache);
		let t = Se[n];
		if (t) return t.auto && t.reload(), t;
	}
	typeof e == `string` && (e = { url: e, auto: !0 });
	let r = e.debounce ? ie(a, e.debounce) : a,
		i = E({
			method: e.method,
			url: e.url,
	...
	function o() {
		return (
			(o = T(function* (r, a = {}) {
				let o = e.resourceFetcher || P(`resourceFetcher`) || de;
				r instanceof Event && (r = null),
					(r = r || i.params),
					e.makeParams && (r = e.makeParams.call(t, r)),
					(i.params = r),
					(i.previousData = i.data ? JSON.parse(JSON.stringify(i.data)) : null),
					(i.loading = !0),
					(i.error = null),
					e.onFetch && e.onFetch.call(t, i.params);
				let s = [e.beforeSubmit, a.beforeSubmit];
				for (let e of s) e && e.call(t, i.params);
				let c = a.validate || e.validate,
					u = [e.onError, a.onError],
					f = [e.onSuccess, a.onSuccess],
					p = [e.onData, a.onData];
				if (c) {
					let e;
					try {
						if (((e = yield c.call(t, i.params)), e && typeof e == `string`))
							throw Error(e);
					} catch (e) {
						l(e, u);
						return;
				...
				try {
					i.promise = o(
						j(j({}, e), {}, { onError: void 0, params: r || e.params })
					);
					let a = yield i.promise;
					_e(n, a), (i.data = d(a)), (i.fetched = !0);
					for (let e of f) e && e.call(t, a);
					for (let e of p) e && e.call(t, a);
				} catch (e) {
					l(e, u);
				}
	...
	function s({ method: t, url: n, params: r, auto: a }) {
		t && t !== e.method && (i.method = t),
			n && n !== e.url && (i.url = n),
			r && r !== e.params && (i.params = r),
			a !== void 0 && a !== i.auto && (i.auto = a);
	}
	function c() {
		(i.data = e.initialData || null),
			(i.previousData = null),
			(i.loading = !1),
			(i.fetched = !1),
			(i.error = null),
	...
	function l(e, n) {
		(i.loading = !1),
			...
			(i.error = e);
		for (let r of n) r && r.call(t, e);
		if (n.every((e) => e == null)) {
			let t = P(`fallbackErrorHandler`);
			if (t)
				try {
					t(e);
				} catch (e) {
					console.warn(`Error in fallbackErrorHandler`, e);
				}
		}
		throw e;
	}
	function u(e) {
		typeof e == `function` && (e = e.call(t, i.data)), (i.data = d(e));
	}
	function d(n) {
		if (e.transform) {
			let r = e.transform.call(t, n);
			if (r != null) return r;
		}
		return n;
	}
	return (
		n &&
			...
			((Se[n] = i),
			ye(n).then((n) => {
				if ((i.loading || !i.fetched) && n) {
					var r;
					u(n), (r = e.onData) == null || r.call(t, n);
				}
			})),
		e.auto && i.fetch(),
		i
...
function we(e) {
	return (e = Ce(e)), Se[e] || null;
}
function Te(e, t, n) {
	De(e, t),
		e.on(`list_update`, (e) => {
			e.doctype == t && n(e.name);
		});
}
var Ee = {};
function De(e, t) {
	Ee[t] || (e.emit(`doctype_subscribe`, t), (Ee[t] = !0));
}
var Oe = [`name`],
	ke = [`method`, `name`],
	Ae = E({}),
...
function Me(e, t) {
	var n, r, i, a, o;
	if (!e.doctype) throw Error(`List resource requires doctype`);
	let s = Ce(e.cache);
	if (s) {
		let e = Ae[s];
		if (e) return e.auto && e.reload(), e;
	}
	let c = P(`defaultListUrl`) || `frappe.client.get_list`,
		l = P(`defaultDocInsertUrl`) || `frappe.client.insert`,
		u = P(`defaultDocUpdateUrl`) || `frappe.client.set_value`,
		d = P(`defaultDocDeleteUrl`) || `frappe.client.delete`,
		f = P(`defaultRunDocMethodUrl`) || `run_doc_method`,
		p = E({
			doctype: e.doctype,
			fields: e.fields,
			filters: e.filters,
			...
			list: F(
				{
					...
					makeParams() {
						return {
							...
							fields: p.fields,
							filters: p.filters,
							or_filters: p.orFilters,
							order_by: p.orderBy,
							start: p.start,
							limit: p.pageLength,
							limit_start: p.start,
							limit_page_length: p.pageLength,
							group_by: p.groupBy,
							parent: p.parent,
							debug: p.debug,
						};
					...
					onSuccess(n) {
						var r;
						(p.hasPreviousPage = !!p.start),
							(p.hasNextPage = !(n.length < p.pageLength));
						let i;
						!p.start || p.start == 0
							? (i = n)
							: p.start > 0 && (i = p.originalData.concat(n)),
							_e(s, i),
							v(i),
							(r = e.onSuccess) == null || r.call(t, p.data);
					},
					onError: e.onError,
				},
				t
			...
			fetchOne: F(
				{
					...
					onError: (n = e.fetchOne) == null ? void 0 : n.onError,
				},
				t
			),
			insert: F(
				{
					url: l,
					makeParams(e) {
						return { doc: j({ doctype: p.doctype }, e) };
					},
					onSuccess(n) {
						var r;
						p.list.fetch(),
					...
					onError: (r = e.insert) == null ? void 0 : r.onError,
				},
				t
			),
			setValue: F(
				{
					...
					makeParams(e) {
						let { name: t } = e,
							n = se(e, Oe);
						return { doctype: p.doctype, name: t, fieldname: n };
					},
					onSuccess(n) {
						var r;
						Pe(p.doctype, n),
					...
					onError: (i = e.setValue) == null ? void 0 : i.onError,
				},
				t
			),
			delete: F(
				{
					url: d,
					makeParams(e) {
						return { doctype: p.doctype, name: e };
					},
					onSuccess(n) {
						var r;
						p.list.fetch(),
					...
					onError: (a = e.delete) == null ? void 0 : a.onError,
				},
				t
			),
			runDocMethod: F(
				{
					url: f,
					makeParams(e) {
						let { method: t, name: n } = e,
							r = se(e, ke);
						return { dt: p.doctype, dn: n, method: t, args: r };
					},
					onSuccess(n) {
						var r;
						if (n.docs) for (let e of n.docs) Pe(e.doctype, e);
						(r = e.runDocMethod) == null ||
							(r = r.onSuccess) == null ||
							r.call(t, n);
					},
					onError: (o = e.runDocMethod) == null ? void 0 : o.onError,
				},
				t
			),
			update: m,
	...
	function g() {
		let e = p.start,
			t = p.pageLength;
		return (
			p.start > 0 && ((p.start = 0), (p.pageLength = p.originalData.length)),
			p.list.fetch().finally(() => {
				(p.start = e), (p.pageLength = t);
			})
		);
	}
	function _() {
	...
	function v(e) {
		if (
			((p.originalData = e),
			typeof e == `function` && (e = e.call(t, p.data)),
			(p.data = h(e)),
			...
			for (let e of p.data) {
				if (!e.name) continue;
				let t = e.name.toString();
				p.dataMap[t] = e;
			}
		}
	}
	function y() {
		(p.start -= p.pageLength), p.list.fetch();
	}
	function b() {
		(p.start += p.pageLength), p.list.fetch();
	}
	...
	return (
		e.realtime &&
			t != null &&
			t.$socket &&
			Te(t.$socket, p.doctype, (e) => {
				var t;
				(t = p.originalData) != null &&
					t.find((t) => t.name === e) &&
					p.fetchOne.submit(e);
			}),
		s &&
			((Ae[s] = p),
			ye(s).then((n) => {
				if ((p.list.loading || !p.list.fetched) && n) {
					var r;
					v(n), (r = e.onData) == null || r.call(t, n);
				}
			})),
		e.auto && p.list.fetch(),
		(je[p.doctype] = je[p.doctype] || []),
		je[p.doctype].push(p),
		p
	);
}
function Ne(e) {
	return (e = Ce(e)), Ae[e] || null;
}
function Pe(e, t) {
	if (!t.name) return;
	let n = je[e] || [];
	for (let e of n)
		if (e.originalData) {
			for (let n of e.originalData)
				if (n.name && n.name == t.name) {
					delete n._previousData;
					let e = JSON.stringify(n);
					for (let e in n) e in t && (n[e] = t[e]);
					n._previousData = e;
				}
			e.data = e.transform(e.originalData);
		}
}
function Fe(e, t) {
	let n = je[e] || [];
	for (let e of n)
		e.originalData &&
			((e.originalData = e.originalData.filter(
...
function Ie(e, t) {
	...
	for (let e of n)
		if (e.originalData) {
			for (let n of e.originalData)
				if (n.name && n.name == t.name) {
					let e = JSON.parse(n._previousData);
...
var Le = [`method`, `onSuccess`, `makeParams`, `transform`],
	Re = E({});
function ze(e, t) {
	var n;
	if (!(e.doctype && e.name)) return;
	let i = Ce([e.doctype, e.name]),
		a = Re[i];
	if (a) return a.auto && a.reload(), a;
	let o = P(`defaultDocGetUrl`) || `frappe.client.get`,
		s = P(`defaultDocUpdateUrl`) || `frappe.client.set_value`,
		c = P(`defaultDocDeleteUrl`) || `frappe.client.delete`,
		l = P(`defaultRunDocMethodUrl`) || `run_doc_method`,
		u = {
			url: s,
			makeParams(e) {
				return { doctype: p.doctype, name: p.name, fieldname: e };
			},
			validate(n) {
				var r;
				(r = e.setValue) == null || (r = r.validate) == null || r.call(t, n);
			},
			beforeSubmit(e) {
				(p.previousDoc = JSON.stringify(p.doc)),
					Object.assign(p.doc, e.fieldname || {}),
					Pe(p.doctype, p.doc);
			},
			onSuccess(n) {
				var r;
				(p.doc = g(n)),
					(p.originalDoc = JSON.parse(JSON.stringify(p.doc))),
					(r = e.setValue) == null || (r = r.onSuccess) == null || r.call(t, n);
			},
			onError(n) {
				var r;
				(p.doc = JSON.parse(p.previousDoc)),
					(r = e.setValue) == null || (r = r.onError) == null || r.call(t, n),
					Ie(p.doctype, p.doc);
			},
		},
		f = e.auto !== void 0,
			...
			get: F(
				{
					...
					method: `GET`,
					makeParams() {
						return { doctype: p.doctype, name: p.name };
					},
					onSuccess(n) {
						var r;
						_e(i, n),
							(p.doc = g(n)),
							(p.originalDoc = JSON.parse(JSON.stringify(p.doc))),
							(r = e.onSuccess) == null || r.call(t, p.doc);
					},
					onError(n) {
						var r;
						ve(i),
							(p.doc = null),
							(p.originalDoc = null),
							(r = e.onError) == null || r.call(t, n);
					},
				},
				t
			),
			setValue: F(u, t),
			setValueDebounced: F(j(j({}, u), {}, { debounce: e.debounce || 500 }), t),
			save: F(
				j(
					j({}, u),
					{},
					{
						makeParams() {
							let e = JSON.parse(JSON.stringify(p.doc));
							return (
								delete e.doctype,
								delete e.name,
								{ doctype: p.doctype, name: p.name, fieldname: e }
							);
						},
					}
				),
			...
			delete: F(
				{
					...
					onSuccess() {
						var n;
						(p.doc = null),
							(n = e.delete) == null || (n = n.onSuccess) == null || n.call(t),
							Fe(p.doctype, p.name);
					},
	...
	d(!0).run(() => {
		r(
			() => p.doc,
			() => {
				p.isDirty = JSON.stringify(p.doc) !== JSON.stringify(p.originalDoc);
			},
			{ deep: !0 }
		);
	});
	for (let n in e.whitelistedMethods) {
		let r = e.whitelistedMethods[n];
		typeof r == `string` && (r = { method: r });
		let { method: i, onSuccess: a, makeParams: o, transform: s } = r,
			c = se(r, Le);
		p[n] = F(
			j(
				{
					...
					makeParams(e) {
						return (
							(e = o ? o.call(t, e) : e),
							{ dt: p.doctype, dn: p.name, method: i, args: e }
						);
					},
					transform(e) {
						if (s) {
							let n = s.call(t, e.message);
							if (n != null) return n;
						}
						return e.message;
					},
					onSuccess(e) {
						if (e.docs) {
							for (let t of e.docs)
								if (
									t.doctype === p.doctype &&
									t.name.toString() === p.name.toString()
								) {
									(p.doc = g(t)), Pe(p.doctype, p.doc);
									break;
								}
						}
						a == null || a.call(t, e.message);
					},
				},
				c
			),
	...
	function h(e) {
		typeof e == `function` && (e = e.call(t, p.doc)), (p.doc = g(e));
	}
	function g(n) {
		if (e.transform) {
			let r = e.transform.call(t, n);
	...
	return (
		e.realtime &&
			t.$socket &&
			Te(t.$socket, p.doctype, (e) => {
				e == p.name && p.get.fetch();
			}),
		(Re[i] = p),
		ye(i).then((e) => {
			(p.get.loading || !p.get.fetched) && e && (p.doc = g(e));
		}),
		p.auto && p.get.fetch(),
		p
	);
	...
	created() {
		if (this.$options.resources) {
			...
			for (let e in this.$options.resources) {
				let t = this.$options.resources[e];
...
`,
						...
						(t, n) => {
							t &&
								(!n || JSON.stringify(t) !== JSON.stringify(n)) &&
								(this._resources[e] = He(t, this));
						},
						{ immediate: !0, deep: !0 }
					);
				else {
	...
	methods: {
		...
		$getDocumentResource(e, t) {
			return Be(e, t);
		},
		$getDoc(e, t) {
			let n = this.$getDocumentResource(e, t);
			return n ? n.doc : null;
		},
		$getListResource(e) {
			return Ne(e);
...
var Ue = {
				...
				return (function (e) {
					...
					"./node_modules/classnames/dedupe.js": function (e, t, n) {
						...
						(function () {
							var n = (function () {
								...
								var a = /\s+/;
								function o(e, t) {
									for (var n = t.split(a), r = n.length, i = 0; i < r; ++i)
										e[n[i]] = !0;
								}
								function s(e, n) {
									if (n) {
					...
					"./node_modules/core-js/internals/array-from.js": function (e, t, n) {
						var r = n(`./node_modules/core-js/internals/bind-context.js`),
							...
							c = n(`./node_modules/core-js/internals/create-property.js`),
						...
						e.exports = function (e) {
							var t = i(e),
								...
								v;
							if (
								(f && (d = r(d, u > 2 ? arguments[2] : void 0, 2)),
								m != null && !(n == Array && o(m)))
							)
								for (v = m.call(t), g = new n(); !(_ = v.next()).done; p++)
									c(g, p, f ? a(v, d, [_.value, p], !0) : _.value);
							else
								for (h = s(t.length), g = new n(h); h > p; p++)
									c(g, p, f ? d(t[p], p) : t[p]);
							return (g.length = p), g;
						};
					},
					"./node_modules/core-js/internals/array-includes.js": function (
						...
						var r = n(`./node_modules/core-js/internals/to-indexed-object.js`),
							...
							a = n(`./node_modules/core-js/internals/to-absolute-index.js`);
						e.exports = function (e) {
					...
					"./node_modules/core-js/internals/classof.js": function (e, t, n) {
						...
						e.exports = function (e) {
							...
							return e === void 0
								...
								: e === null
								? `Null`
								: typeof (n = o((t = Object(e)), i)) == `string`
								? n
								: a
								? r(t)
								: (s = r(t)) == `Object` && typeof t.callee == `function`
								? `Arguments`
								: s;
						};
					},
					...
					"./node_modules/core-js/internals/correct-prototype-getter.js":
						function (e, t, n) {
							e.exports = !n(`./node_modules/core-js/internals/fails.js`)(
								function () {
									function e() {}
									return (
					...
					"./node_modules/core-js/internals/define-iterator.js": function (
						...
						e.exports = function (e, t, n, u, p, ee, te) {
							i(n, t, u);
							var x = function (e) {
									if (e === p && T) return T;
								...
								S = !1,
								C = e.prototype,
								w = C[g] || C[`@@iterator`] || (p && C[p]),
								T = (!h && w) || x(p),
								E = (t == `Array` && C.entries) || w,
								D,
								O,
								k;
							if (
								(E &&
									...
									m !== Object.prototype &&
										...
										(!d &&
											a(D) !== m &&
											(o ? o(D, m) : typeof D[g] != `function` && c(D, g, b)),
										s(D, ne, !0, !0),
										d && (f[ne] = b))),
								p == v &&
									w &&
								...
								if (
									((O = { values: x(v), keys: ee ? T : x(_), entries: x(y) }),
									te)
								)
									for (k in O) (h || S || !(k in C)) && l(C, k, O[k]);
								else r({ target: t, proto: !0, forced: h || S }, O);
							return O;
						};
					},
					...
					"./node_modules/core-js/internals/function-to-string.js": function (
						...
						e.exports = n(`./node_modules/core-js/internals/shared.js`)(
					...
					"./node_modules/core-js/internals/internal-state.js": function (
						...
						var r = n(`./node_modules/core-js/internals/native-weak-map.js`),
						...
						e.exports = { set: d, get: f, has: p, enforce: m, getterFor: h };
					},
					"./node_modules/core-js/internals/is-array-iterator-method.js":
						function (e, t, n) {
							var r = n(
					...
					"./node_modules/core-js/internals/iterators-core.js": function (
						...
						[].keys &&
							((p = [].keys()),
							`next` in p
								? ((f = r(r(p))), f !== Object.prototype && (d = f))
								: (l = !0)),
							d == null && (d = {}),
							!s && !a(d, c) && i(d, c, u),
							(e.exports = { IteratorPrototype: d, BUGGY_SAFARI_ITERATORS: l });
					},
					...
					"./node_modules/core-js/internals/object-create.js": function (
						...
						var r = n(`./node_modules/core-js/internals/an-object.js`),
							...
							l = n(`./node_modules/core-js/internals/shared-key.js`)(
								`IE_PROTO`
							),
							u = `prototype`,
							d = function () {},
							f = function () {
								...
								for (
									e.style.display = `none`,
										...
										l.open(),
										l.write(n + r + i + `document.F=Object` + n + `/` + r + i),
										l.close(),
										f = l.F;
									t--;
						...
						(e.exports =
							...
							function (e, t) {
								...
								return (
									e === null
										? (n = f())
										: ((d[u] = r(e)), (n = new d()), (d[u] = null), (n[l] = e)),
									t === void 0 ? n : i(n, t)
								);
							}),
							(o[l] = !0);
					...
					"./node_modules/core-js/internals/object-define-properties.js":
						function (e, t, n) {
							...
							e.exports = r
								...
								: function (e, t) {
										a(e);
										for (var n = o(t), r = n.length, s = 0, c; r > s; )
											i.f(e, (c = n[s++]), t[c]);
										return e;
								  };
						},
					...
					"./node_modules/core-js/internals/object-keys-internal.js": function (
						...
						var r = n(`./node_modules/core-js/internals/has.js`),
							...
							a = n(`./node_modules/core-js/internals/array-includes.js`),
							o = n(`./node_modules/core-js/internals/hidden-keys.js`),
							s = a(!1);
						e.exports = function (e, t) {
							var n = i(e),
					...
					"./node_modules/core-js/internals/redefine.js": function (e, t, n) {
						var r = n(`./node_modules/core-js/internals/global.js`),
							...
							s = n(`./node_modules/core-js/internals/set-global.js`),
							c = n(`./node_modules/core-js/internals/function-to-string.js`),
						...
						i(`inspectSource`, function (e) {
							...
							(e.exports = function (e, t, n, i) {
								...
								if (
									(typeof n == `function` &&
										(typeof t == `string` && !o(n, `name`) && a(n, `name`, t),
										(d(n).source = f.join(typeof t == `string` ? t : ``))),
									e === r)
								) {
									l ? (e[t] = n) : s(t, n);
									return;
								} else c ? !u && e[t] && (l = !0) : delete e[t];
								l ? (e[t] = n) : a(e, t, n);
							})(Function.prototype, `toString`, function () {
								return (
									(typeof this == `function` && u(this).source) || c.call(this)
								);
							});
					},
					...
					"./node_modules/core-js/internals/shared.js": function (e, t, n) {
						var r = n(`./node_modules/core-js/internals/global.js`),
							...
							a = n(`./node_modules/core-js/internals/is-pure.js`),
					...
					"./node_modules/core-js/internals/uid.js": function (e, t) {
						var n = 0,
							r = Math.random();
						e.exports = function (e) {
							return `Symbol(${e === void 0 ? `` : e})_${(++n + r).toString(
								36
							)}`;
						};
					},
					...
					"./node_modules/core-js/internals/well-known-symbol.js": function (
						...
						var r = n(`./node_modules/core-js/internals/global.js`),
							...
							o = n(`./node_modules/core-js/internals/native-symbol.js`),
							s = r.Symbol,
							c = i(`wks`);
						e.exports = function (e) {
					...
					"./src/icon.js": function (e, t, n) {
						...
						var r =
							...
							a = s(n(`./node_modules/classnames/dedupe.js`)),
							o = s(n(`./src/default-attrs.json`));
						function s(e) {
					...
					"./src/icons.js": function (e, t, n) {
						Object.defineProperty(t, `__esModule`, { value: !0 });
						var r = o(n(`./src/icon.js`)),
							i = o(n(`./dist/icons.json`)),
							a = o(n(`./src/tags.json`));
						function o(e) {
							return e && e.__esModule ? e : { default: e };
						}
					...
					"./src/index.js": function (e, t, n) {
						var r = o(n(`./src/icons.js`)),
							i = o(n(`./src/to-svg.js`)),
							a = o(n(`./src/replace.js`));
						function o(e) {
							return e && e.__esModule ? e : { default: e };
						}
						e.exports = {
					...
					"./src/replace.js": function (e, t, n) {
						...
						var r =
							...
							i = o(n(`./node_modules/classnames/dedupe.js`)),
							a = o(n(`./src/icons.js`));
						function o(e) {
							return e && e.__esModule ? e : { default: e };
						}
	...
	Ge = Object.keys(We.default.icons),
	Ke = {
		props: {
			name: {
				type: String,
		...
		render() {
			let e = We.default.icons[this.name];
			return (
				e || (e = We.default.icons.circle),
				l(
					`svg`,
					o(
						e.attrs,
...
function mt(e) {
	return pt(e).replace(lt, `{`).replace(dt, `}`).replace(st, `^`);
}
function ht(e) {
	return pt(e)
		.replace(it, `%2B`)
...
function gt(e) {
	return ht(e).replace(nt, `%3D`);
}
function _t(e) {
	return pt(e).replace($e, `%23`).replace(rt, `%3F`);
}
function vt(e) {
	return _t(e).replace(tt, `%2F`);
}
function yt(e) {
...
function St(e, t, n = `/`) {
	...
	return (
		...
		(r = kt(r == null ? t : r, n)),
		{ fullPath: r + a + o, path: r, query: i, hash: yt(o) }
	);
}
function Ct(e, t) {
...
function Tt(e, t, n) {
	...
	return (
		r > -1 &&
		r === i &&
		z(t.matched[r], n.matched[i]) &&
		Et(t.params, n.params) &&
		e(t.query) === e(n.query) &&
		t.hash === n.hash
	);
}
...
function Et(e, t) {
	...
	for (var n in e) if (!Dt(e[n], t[n])) return !1;
	return !0;
}
function Dt(e, t) {
	return R(e)
...
var It = () => ({ left: window.scrollX, top: window.scrollY });
function Lt(e) {
	let t;
	if (`el` in e) {
		let n = e.el,
...
var V = (function (e) {
	...
	Wt = Symbol(``);
V.MATCHER_NOT_FOUND,
	V.NAVIGATION_GUARD_REDIRECT,
	V.NAVIGATION_ABORTED,
	V.NAVIGATION_CANCELLED,
	V.NAVIGATION_DUPLICATED;
function H(e, t) {
	return L(Error(), { type: e, [Wt]: !0 }, t);
}
function U(e, t) {
...
function Gt(e) {
	...
	for (let e = 0; e < n.length; ++e) {
		let r = n[e].replace(it, ` `),
			i = r.indexOf(`=`),
			a = yt(i < 0 ? r : r.slice(0, i)),
			o = i < 0 ? null : yt(r.slice(i + 1));
		if (a in t) {
			let e = t[a];
			R(e) || (e = t[a] = [e]), e.push(o);
		} else t[a] = o;
	}
	return t;
}
function Kt(e) {
	...
	for (let n in e) {
		...
		(R(r) ? r.map((e) => e && ht(e)) : [r && ht(r)]).forEach((e) => {
			e !== void 0 &&
...
function W(e, t, n, r, i, a = (e) => e()) {
	let o = r && (r.enterCallbacks[i] = r.enterCallbacks[i] || []);
	return () =>
		new Promise((s, c) => {
			let l = (e) => {
					e === !1
						? c(H(V.NAVIGATION_ABORTED, { from: n, to: t }))
						: e instanceof Error
						? c(e)
						: Ht(e)
						? c(H(V.NAVIGATION_GUARD_REDIRECT, { from: t, to: e }))
						: (o &&
				...
				if (Je(s)) {
					...
					a.push(() =>
						c.then((a) => {
							...
							let s = Ye(a) ? a.default : a;
							(o.mods[e] = a), (o.components[e] = s);
							let c = (s.__vccOpts || s)[t];
							return c && W(c, n, r, o, e, i)();
						})
					);
				}
		}
...
var nn = () => location.protocol + `//` + location.host;
function rn(e, t) {
...
function an(e, t, n, r) {
		...
		s = ({ state: a }) => {
			...
			i.forEach((e) => {
				e(n.value, c, {
					delta: u,
					type: At.pop,
					direction: u ? (u > 0 ? jt.forward : jt.back) : jt.unknown,
				});
			});
		};
	function c() {
	...
	function u() {
		if (document.visibilityState === `hidden`) {
			...
			if (!e.state) return;
			e.replaceState(L({}, e.state, { scroll: It() }), ``);
		}
	}
	function d() {
		for (let e of a) e();
...
function sn(e) {
	...
	function o(e, n) {
		a(
			e,
			L({}, t.state, on(i.value.back, e, i.value.forward, !0), n, {
	...
	function s(e, n) {
		let o = L({}, i.value, t.state, { forward: e, scroll: It() });
		a(o.current, o, !0),
			a(e, L({}, on(r.value, e, null), { position: o.position + 1 }, n), !1),
			(r.value = e);
	}
...
function dn(e) {
	...
	function d() {
		l &&
			(n === K.Static
				? a.push({ type: G.Static, value: l })
				: n === K.Param || n === K.ParamRegExp || n === K.ParamRegExpEnd
				? (a.length > 1 &&
						(c === `*` || c === `+`) &&
						t(
	...
	for (; s < e.length; ) {
		if (((c = e[s++]), c === `\\` && n !== K.ParamRegExp)) {
			(r = n), (n = K.EscapeNext);
			continue;
		}
		switch (n) {
			case K.Static:
				c === `/` ? (l && d(), o()) : c === `:` ? (d(), (n = K.Param)) : f();
				break;
			case K.EscapeNext:
				f(), (n = r);
				break;
	...
	return (
		n === K.ParamRegExp && t(`Unfinished custom RegExp for param "${l}"`),
		d(),
		o(),
		i
	);
...
var fn = `[^/]+?`,
	pn = { sensitive: !1, strict: !1, start: !0, end: !0 },
	q = (function (e) {
		return (
...
function hn(e, t) {
	let n = L({}, pn, t),
		...
		a = [];
	for (let t of e) {
		let e = t.length ? [] : [q.Root];
		n.strict && !t.length && (i += `/`);
		for (let r = 0; r < t.length; r++) {
			let o = t[r],
				s = q.Segment + (n.sensitive ? q.BonusCaseSensitive : 0);
			if (o.type === G.Static)
				r || (i += `/`), (i += o.value.replace(mn, `\\$&`)), (s += q.Static);
			else if (o.type === G.Param) {
				let { value: e, repeatable: n, optional: c, regexp: l } = o;
				a.push({ name: e, repeatable: n, optional: c });
				let u = l || fn;
				if (u !== fn) {
					s += q.BonusCustomRegExp;
					try {
						`${u}`;
					} catch (t) {
						throw Error(
	...
	if (n.strict && n.end) {
		let e = r.length - 1;
		r[e][r[e].length - 1] += q.BonusStrict;
	}
	n.strict || (i += `/?`),
	...
	function c(t) {
		...
		for (let i of e) {
			(!r || !n.endsWith(`/`)) && (n += `/`), (r = !1);
			for (let e of i)
				if (e.type === G.Static) n += e.value;
				else if (e.type === G.Param) {
...
function gn(e, t) {
	...
	return e.length < t.length
		? e.length === 1 && e[0] === q.Static + q.Segment
			? -1
			: 1
		: e.length > t.length
		? t.length === 1 && t[0] === q.Static + q.Segment
			? 1
			: -1
		: 0;
}
...
var yn = { strict: !1, end: !0, sensitive: !1 };
function bn(e, t, n) {
	let r = L(hn(dn(e.path), n), {
		record: e,
		parent: t,
		children: [],
		alias: [],
...
function xn(e, t) {
	...
	function c(e) {
		let t = Dn(e, n);
		n.splice(t, 0, e), e.record.name && !Tn(e) && r.set(e.record.name, e);
	}
	function l(e, t) {
		let i,
			a = {},
		...
		if (`name` in e && e.name) {
			if (((i = r.get(e.name)), !i))
				throw H(V.MATCHER_NOT_FOUND, { location: e });
			(s = i.record.name),
				(a = L(
					Sn(
						t.params,
			...
			if (((i = t.name ? r.get(t.name) : n.find((e) => e.re.test(t.path))), !i))
				throw H(V.MATCHER_NOT_FOUND, { location: e, currentLocation: t });
			(s = i.record.name),
		...
		return { name: s, path: o, params: a, matched: c, meta: En(c) };
	}
	e.forEach((e) => a(e));
	function u() {
		(n.length = 0), r.clear();
...
function On(e) {
	let t = e;
	for (; (t = t.parent); ) if (kn(t) && _n(e, t) === 0) return t;
}
...
function An(e) {
	let n = t(Xt),
		...
		a = S(() => {
			...
			let o = a.findIndex(z.bind(null, n));
			if (o > -1) return o;
			let s = Fn(e[t - 2]);
			return t > 1 && Fn(n) === s && a[a.length - 1].path !== s
				? a.findIndex(z.bind(null, e[t - 2]))
				: o;
		}),
		o = S(() => a.value > -1 && Pn(r.params, i.value.params)),
		s = S(
			() =>
				a.value > -1 &&
				a.value === r.matched.length - 1 &&
				Et(r.params, i.value.params)
		);
	function c(t = {}) {
		if (Nn(t)) {
			let t = n[h(e.replace) ? `replace` : `push`](h(e.to)).catch(Ze);
			return (
				e.viewTransition &&
					typeof document < `u` &&
					`startViewTransition` in document &&
					document.startViewTransition(() => t),
				t
			);
		}
...
var Mn = c({
	...
	setup(e, { slots: n }) {
		let r = E(An(e)),
			{ options: i } = t(Xt),
			a = S(() => ({
				[In(e.activeClass, i.linkActiveClass, `router-link-active`)]:
					r.isActive,
				[In(
					e.exactActiveClass,
		...
		return () => {
			let t = n.default && jn(n.default(r));
			return e.custom
				? t
				: l(
						`a`,
...
var In = (e, t, n) => (e == null ? (t == null ? n : t) : e),
	Ln = c({
		name: `RouterView`,
		inheritAttrs: !1,
			...
			return (
				...
				() => {
					let t = s.value,
						...
						i = d.value,
						o = i && i.components[r];
					if (!o) return Rn(a.default, { Component: o, route: t });
					let c = i.props[r],
						u = l(
							o,
							L(
					...
					return Rn(a.default, { Component: u, route: t }) || u;
				}
			);
		},
	});
...
function Bn(e) {
	...
	let u = Xe.bind(null, (e) => `` + e),
		d = Xe.bind(null, vt),
		f = Xe.bind(null, yt);
	function p(e, n) {
		let r, i;
		return (
			Ut(e) ? ((r = t.getRecordMatcher(e)), (i = n)) : (i = e), t.addRoute(i, r)
		);
	}
	function m(e) {
	...
	function v(e, a) {
		if (((a = L({}, a || c.value)), typeof e == `string`)) {
			let r = St(n, e, a.path),
		...
		let o;
		if (e.path != null) o = L({}, e, { path: St(n, e.path, a.path).path });
		else {
			let t = L({}, e.params);
			for (let e in t) t[e] == null && delete t[e];
			(o = L({}, e, { params: d(t) })), (a.params = d(a.params));
		}
		let s = t.resolve(o, a),
			l = e.hash || ``;
		s.params = u(f(s.params));
		let p = Ct(r, L({}, e, { hash: mt(l), path: s.path })),
			m = i.createHref(p);
		return L(
			{ fullPath: p, hash: l, query: r === Kt ? qt(e.query) : e.query || {} },
			s,
			{ redirectedFrom: void 0, href: m }
		);
	}
	function y(e) {
		return typeof e == `string` ? St(n, e, c.value.path) : L({}, e);
	}
	function b(e, t) {
		if (l !== e) return H(V.NAVIGATION_CANCELLED, { from: t, to: e });
	}
	function x(e) {
		return w(e);
	}
	function S(e) {
		return x(L(y(e), { replace: !0 }));
	}
	function C(e, t) {
	...
	function w(e, t) {
		...
		if (u)
			return w(
				L(y(u), {
					state: typeof u == `object` ? L({}, a, u.state) : a,
					force: o,
					replace: s,
				}),
				t || n
		...
		return (
			!o &&
				Tt(r, i, n) &&
				((f = H(V.NAVIGATION_DUPLICATED, { to: d, from: i })),
				le(i, i, !0, !1)),
			(f ? Promise.resolve(f) : D(d, i))
				.catch((e) =>
					U(e) ? (U(e, V.NAVIGATION_GUARD_REDIRECT) ? e : ce(e)) : oe(e, d, i)
				)
				.then((e) => {
					if (e) {
						if (U(e, V.NAVIGATION_GUARD_REDIRECT))
							return w(
								L({ replace: s }, y(e.to), {
									state: typeof e.to == `object` ? L({}, a, e.to.state) : a,
									force: o,
								}),
								t || d
							);
	...
	function D(e, t) {
		...
		return (
			...
			N(n)
				.then(() => {
					n = [];
					for (let r of a.list()) n.push(W(r, e, t));
					return n.push(c), N(n);
				})
				.then(() => {
				...
				.then(() => {
					...
					for (let r of s)
						if (r.beforeEnter)
							if (R(r.beforeEnter))
								for (let i of r.beforeEnter) n.push(W(i, e, t));
							else n.push(W(r.beforeEnter, e, t));
					return n.push(c), N(n);
				})
				.then(
					() => (
						e.matched.forEach((e) => (e.enterCallbacks = {})),
						(n = en(s, `beforeRouteEnter`, e, t, E)),
						n.push(c),
						N(n)
					)
				)
				.then(() => {
					n = [];
					for (let r of o.list()) n.push(W(r, e, t));
					return n.push(c), N(n);
				})
				.catch((e) => (U(e, V.NAVIGATION_CANCELLED) ? e : Promise.reject(e)))
		);
	}
	function O(e, t, n) {
	...
	function k(e, t, n, r, a) {
		...
		n &&
			(r || s
				? i.replace(e.fullPath, L({ scroll: s && l && l.scroll }, a))
				: i.push(e.fullPath, a)),
			(c.value = e),
			le(e, t, n, s),
			ce();
	...
	function re() {
		A ||
			(A = i.listen((e, t, n) => {
				...
				let r = v(e),
					a = C(r, fe.currentRoute.value);
				if (a) {
					w(L(a, { replace: !0, force: !0 }), r).catch(Ze);
					return;
				}
				l = r;
				let o = c.value;
				I && Bt(Rt(o.fullPath, n.delta), It()),
					D(r, o)
						.catch((e) =>
							U(e, V.NAVIGATION_ABORTED | V.NAVIGATION_CANCELLED)
								? e
								: U(e, V.NAVIGATION_GUARD_REDIRECT)
								? (w(L(y(e.to), { force: !0 }), r)
										.then((e) => {
											U(e, V.NAVIGATION_ABORTED | V.NAVIGATION_DUPLICATED) &&
												!n.delta &&
												n.type === At.pop &&
												i.go(-1, !1);
										})
						...
						.then((e) => {
							(e = e || k(r, o, !1)),
								e &&
									(n.delta && !U(e, V.NAVIGATION_CANCELLED)
										? i.go(-n.delta, !1)
										: n.type === At.pop &&
										  U(e, V.NAVIGATION_ABORTED | V.NAVIGATION_DUPLICATED) &&
										  i.go(-1, !1)),
	...
	let ue = (e) => i.go(e),
		...
		fe = {
			...
			isReady: se,
			install(e) {
				e.component(`RouterLink`, Mn),
					e.component(`RouterView`, zn),
				...
				e.provide(Xt, fe), e.provide(Zt, ee(t)), e.provide(Qt, c);
				let n = e.unmount;
				M.add(e),
					(e.unmount = function () {
						M.delete(e),
...
var Hn = [`disabled`, `aria-label`, `type`],
	Un = c(
		j(
			j({}, { inheritAttrs: !1 }),
			{},
					...
					let i = t,
						...
						d = S(() => {
							let e = {
								...
								o = { subtle: t, solid: e, outline: n, ghost: r }[i.variant],
								s = {
						...
						m = S(
							() =>
								({ sm: `h-4`, md: `h-4.5`, lg: `h-5`, xl: `h-6`, "2xl": `h-6` }[
									i.size
								])
						),
						y = S(
						...
						b = S(() => i.disabled || i.loading),
						ee = S(() => i.icon || c.icon || te.value),
						te = S(() => {
							var e, t;
							...
							let r = n[0];
							return !!(
								typeof ((e = r.type) == null ? void 0 : e.name) == `string` &&
								!((t = r.type) == null || (t = t.name) == null) &&
								t.startsWith(`lucide-`)
							);
						}),
						ne = () => {
							if (i.route) return l.push(i.route);
							if (i.link) return window.open(i.link, `_blank`);
						},
						T = w();
					return (
						r({ rootRef: T }),
									...
									k(h(le), null, {
										default: a(() => {
											...
											return [
															...
															x(
																...
																[
																	t.loading
																		  ...
																		  v(
																				qe,
																				{
																					...
																					class: C({
																						...
																						"h-[13.5px] w-[13.5px]":
																							t.size == `md`,
																						"h-[15px] w-[15px]": t.size == `lg`,
																						"h-4.5 w-4.5":
																							t.size == `xl` || t.size == `2xl`,
																					}),
																				},
																				null,
																				8,
																		...
																		: r.$slots.prefix || t.iconLeft
																		? s(r.$slots, `prefix`, { key: 1 }, () => [
																				t.iconLeft &&
																				typeof t.iconLeft == `string` &&
																				t.iconLeft.startsWith(`lucide-`)
																					? (n(),
																					  f(
																							`span`,
																							{
																								key: 0,
																								class: C([t.iconLeft, y.value]),
																								"aria-hidden": `true`,
																							},
																							null,
																							2
																		...
																		? (n(),
																		  f(
																				...
																				[
																					...
																					t.icon.startsWith(`lucide-`)
																						? (n(),
																						  f(
																								`span`,
																								{
																									key: 0,
																									class: C([t.icon, y.value]),
																									"aria-hidden": `true`,
																								},
																								null,
																								2
																						...
																						: r.$slots.icon
																						? s(r.$slots, `icon`, { key: 3 })
																						: te.value
																						? (n(),
																						  f(
																								`div`,
																								{ key: 4, class: C(m.value) },
																								[
																									s(
																										r.$slots,
																										`default`,
																	...
																	s(r.$slots, `suffix`, {}, () => [
																		t.iconRight &&
																		typeof t.iconRight == `string` &&
																		t.iconRight.startsWith(`lucide-`)
																			? (n(),
																			  f(
																					`span`,
																					{
																						key: 0,
																						class: C([t.iconRight, y.value]),
																						"aria-hidden": `true`,
																					},
																					null,
																					2
												...
												(c = t.tooltip) != null && c.length
													? (n(),
													  v(ue, { key: 0, text: t.tooltip }, null, 8, [
															`text`,
													  ]))
													: g(``, !0),
											];
			...
			return (e, i) => (
				...
				f(
					...
					[
						e.$slots.prefix
							? (n(),
							  f(
									...
									{
										key: 0,
										class: C([t.size == `lg` ? `max-h-6` : `max-h-4`]),
									},
									[s(e.$slots, `prefix`)],
									2
							  ))
						...
						s(e.$slots, `default`, {}, () => {
							var e;
							return [p(_((e = t.label) == null ? void 0 : e.toString()), 1)];
						}),
						e.$slots.suffix
							? (n(),
							  f(
	...
	Gn = `modulepreload`,
	Kn = function (e) {
		return `/assets/stride/frontend/` + e;
	},
	qn = {},
	Jn = function (e, t, n) {
...
function Xn() {
	return (
		(Xn = T(function* (e, t, n = {}) {
			...
			let i = e.startsWith(`/`) ? e : `/api/method/${e}`,
				a = yield fetch(i, {
					method: `POST`,
					headers: r,
			...
			if (a.ok) {
				...
				let o = [[e, r.exc_type, r._error_message].filter(Boolean).join(` `)];
				if (r.exc) {
					i = r.exc;
					try {
...
`)
				...
				throw (
					((s.exc_type = r.exc_type),
					(s.exc = i),
					(s.status = a.status),
					(s.messages = r._server_messages
						? JSON.parse(r._server_messages)
						: []),
					(s.messages = s.messages.concat(r.message)),
					...
					s.messages.length ||
						(s.messages = r._error_message
							? [r._error_message]
							: [`Internal Server Error`]),
					n.onError && n.onError({ response: a, status: a.status, error: s }),
					s)
				);
			}
		})),
...
function Zn(e) {
	return de(
		j(
			...
			{
				transformRequest: (e = {}) => {
					if (!e.url) throw Error(`[frappeRequest] options.url is required`);
					let t = Object.assign(
						{
							Accept: `application/json`,
							"Content-Type": `application/json; charset=utf-8`,
					...
					return (
						window.csrf_token &&
							window.csrf_token !== `{{ csrf_token }}` &&
							(t[`X-Frappe-CSRF-Token`] = window.csrf_token),
						!e.url.startsWith(`/`) &&
							!e.url.startsWith(`http`) &&
							(e.url = `/api/method/` + e.url),
						j(j({}, e), {}, { method: e.method || `POST`, headers: t })
					);
				},
				transformResponse: (function () {
					var e = T(function* (e, t) {
						...
						if (e.ok) {
							let r = yield e.json();
							if (r.docs || n === `/api/method/login`) return r;
							if (r.exc)
								try {
									console.groupCollapsed(n), console.log(t);
							...
							if (r._server_messages) {
								let e =
									P(`serverMessagesHandler`) || t.onServerMessages || null;
								e &&
									e(JSON.parse(r == null ? void 0 : r._server_messages) || []);
							}
							return r.message;
						} else {
							let n = yield e.text(),
							...
							let a = [
								[
									t.url,
									r == null ? void 0 : r.exc_type,
									r == null ? void 0 : r._error_message,
								]
									.filter(Boolean)
									.join(` `),
							];
...
`)
							...
							throw (
								((o.exc_type = r.exc_type),
								(o.exc = i),
								(o.response = e),
								(o.status = n.status),
								(o.messages = r._server_messages
									? JSON.parse(r._server_messages)
									: []),
								(o.messages = o.messages.concat(r.message)),
								(o.messages = o.messages.map((e) => {
									try {
										return JSON.parse(e).message;
									} catch (t) {
										return e;
...
var $n = { type: `error`, data: `parser error` },
	...
	tr = typeof ArrayBuffer == `function`,
	nr = (e) =>
		typeof ArrayBuffer.isView == `function`
			? ArrayBuffer.isView(e)
			: e && e.buffer instanceof ArrayBuffer,
	rr = ({ type: e, data: t }, n, r) =>
		er && t instanceof Blob
			? n
				? r(t)
				: ir(t, r)
			: tr && (t instanceof ArrayBuffer || nr(t))
			? n
				? r(t)
				: ir(new Blob([t]), r)
			: r(J[e] + (t || ``)),
...
var or;
function sr(e, t) {
	if (er && e.data instanceof Blob)
		return e.data.arrayBuffer().then(ar).then(t);
	if (tr && (e.data instanceof ArrayBuffer || nr(e.data))) return t(ar(e.data));
	rr(e, !1, (e) => {
		or || (or = new TextEncoder()), t(or.encode(e));
	});
}
var cr = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/`,
	lr = typeof Uint8Array > `u` ? [] : new Uint8Array(256);
for (let e = 0; e < 64; e++) lr[cr.charCodeAt(e)] = e;
var ur = (e) => {
		let t = e.length * 0.75,
			n = e.length,
			r,
		...
		for (r = 0; r < n; r += 4)
			(a = lr[e.charCodeAt(r)]),
				(o = lr[e.charCodeAt(r + 1)]),
				(s = lr[e.charCodeAt(r + 2)]),
				(c = lr[e.charCodeAt(r + 3)]),
				(u[i++] = (a << 2) | (o >> 4)),
				(u[i++] = ((o & 15) << 4) | (s >> 2)),
				(u[i++] = ((s & 3) << 6) | (c & 63));
		return l;
	},
	dr = typeof ArrayBuffer == `function`,
	fr = (e, t) => {
		if (typeof e != `string`) return { type: `message`, data: mr(e, t) };
		let n = e.charAt(0);
		return n === `b`
			? { type: `message`, data: pr(e.substring(1), t) }
			: Qn[n]
			? e.length > 1
				? { type: Qn[n], data: e.substring(1) }
				: { type: Qn[n] }
			: $n;
	},
	pr = (e, t) => (dr ? mr(ur(e), t) : { base64: !0, data: e }),
	mr = (e, t) => {
		switch (t) {
			case `blob`:
		...
		transform(o, s) {
			for (n.push(o); ; ) {
				if (r === 0) {
					...
					if (br(n) < i) break;
					let e = xr(n, i);
					s.enqueue(fr(a ? e : yr.decode(e), t)), (r = 0);
				}
				if (i === 0 || i > e) {
					s.enqueue($n);
					break;
...
function kr(e, t) {
	t.useNativeTimers
		? ((e.setTimeoutFn = Dr.bind(X)), (e.clearTimeoutFn = Or.bind(X)))
...
function jr(e) {
	return typeof e == `string`
		? Mr(e)
		: Math.ceil((e.byteLength || e.size) * Ar);
}
function Mr(e) {
	let t = 0,
		n = 0;
...
var Ir = class extends Error {
	...
	Lr = class extends Y {
		...
		onError(e, t, n) {
			return super.emitReserved(`error`, new Ir(e, t, n)), this;
		}
		open() {
		...
		onData(e) {
			let t = fr(e, this.socket.binaryType);
			this.onPacket(t);
		}
		onPacket(e) {
	...
	Rr = class extends Lr {
		...
		onData(e) {
			_r(e, this.socket.binaryType).forEach((e) => {
				if (
	...
	zr = !1;
try {
	zr = typeof XMLHttpRequest < `u` && `withCredentials` in new XMLHttpRequest();
} catch (e) {}
var Br = zr;
function Vr() {}
var Hr = class extends Rr {
		constructor(e) {
	...
	Ur = class e extends Y {
		...
		_cleanup(t) {
			if (!(this._xhr === void 0 || this._xhr === null)) {
				if (((this._xhr.onreadystatechange = Vr), t))
					try {
						this._xhr.abort();
					} catch (e) {}
...
if (((Ur.requestsCount = 0), (Ur.requests = {}), typeof document < `u`)) {
	if (typeof attachEvent == `function`) attachEvent(`onunload`, Wr);
	else if (typeof addEventListener == `function`) {
		let e = `onpagehide` in X ? `pagehide` : `unload`;
		addEventListener(e, Wr, !1);
	}
}
function Wr() {
	for (let e in Ur.requests)
		Ur.requests.hasOwnProperty(e) && Ur.requests[e].abort();
}
var Gr = (function () {
		let e = qr({ xdomain: !1 });
	...
	Kr = class extends Hr {
		constructor(e) {
			...
			this.supportsBinary = Gr && !t;
		}
		request(e = {}) {
			return (
				Object.assign(e, { xd: this.xd }, this.opts), new Ur(qr, this.uri(), e)
			);
		}
	};
function qr(e) {
	let t = e.xdomain;
	try {
		if (typeof XMLHttpRequest < `u` && (!t || Br)) return new XMLHttpRequest();
	} catch (e) {}
	if (!t)
		try {
	...
	Yr = class extends Lr {
		...
		uri() {
			let e = this.opts.secure ? `wss` : `ws`,
				t = this.query || {};
			return (
				this.opts.timestampRequests && (t[this.opts.timestampParam] = Nr()),
				this.supportsBinary || (t.b64 = 1),
				this.createUri(e, t)
			);
		}
	},
	Xr = X.WebSocket || X.MozWebSocket,
	Zr = {
		websocket: class extends Yr {
			createSocket(e, t, n) {
				return Jr ? new Xr(e, t, n) : t ? new Xr(e, t) : new Xr(e);
			}
			doWrite(e, t) {
				this.ws.send(t);
			}
				...
				this._transport.closed
					...
					this._transport.ready.then(() => {
						this._transport.createBidirectionalStream().then((e) => {
							let t = Sr(9007199254740991, this.socket.binaryType),
...
var ai = class e extends Y {
	constructor(e, t) {
		...
		} else t.host && (t.hostname = ei(t.host).host);
		kr(this, t),
			(this.secure =
				t.secure == null
			...
			typeof this.opts.query == `string` &&
				(this.opts.query = Fr(this.opts.query)),
			ri &&
	...
	_getWritablePackets() {
		...
		for (let t = 0; t < this.writeBuffer.length; t++) {
			...
			if ((n && (e += jr(n)), t > 0 && e > this._maxPayload))
						...
						if (!n)
							if (e.type === `pong` && e.data === `probe`) {
								if (
									...
									return;
								(ai.priorWebsocketSuccess = t.name === `websocket`),
...
var li = typeof ArrayBuffer == `function`,
	ui = (e) =>
		typeof ArrayBuffer.isView == `function`
			? ArrayBuffer.isView(e)
	...
	di = Object.prototype.toString,
		...
		typeof Blob == `function` ||
		(typeof Blob < `u` && di.call(Blob) === `[object BlobConstructor]`),
	pi =
		typeof File == `function` ||
		(typeof File < `u` && di.call(File) === `[object FileConstructor]`);
function mi(e) {
	return (
		(li && (e instanceof ArrayBuffer || ui(e))) ||
		(fi && e instanceof Blob) ||
		(pi && e instanceof File)
	);
}
function hi(e, t) {
	if (!e || typeof e != `object`) return !1;
	if (Array.isArray(e)) {
		for (let t = 0, n = e.length; t < n; t++) if (hi(e[t])) return !0;
		return !1;
	}
	if (mi(e)) return !0;
	if (e.toJSON && typeof e.toJSON == `function` && arguments.length === 1)
		return hi(e.toJSON(), !0);
	for (let t in e)
		if (Object.prototype.hasOwnProperty.call(e, t) && hi(e[t])) return !0;
	return !1;
}
function gi(e) {
	let t = [],
		...
		r = e;
	return (
		(r.data = _i(n, t)), (r.attachments = t.length), { packet: r, buffers: t }
	);
}
function _i(e, t) {
	if (!e) return e;
	if (mi(e)) {
		...
		let n = {};
		for (let r in e)
			Object.prototype.hasOwnProperty.call(e, r) && (n[r] = _i(e[r], t));
		return n;
	}
	return e;
}
function vi(e, t) {
	return (e.data = yi(e.data, t)), delete e.attachments, e;
}
function yi(e, t) {
	if (!e) return e;
	if (e && e._placeholder === !0) {
		...
		for (let n = 0; n < e.length; n++) e[n] = yi(e[n], t);
	else if (typeof e == `object`)
		for (let n in e)
			Object.prototype.hasOwnProperty.call(e, n) && (e[n] = yi(e[n], t));
	return e;
}
var bi = A({
		Decoder: () => Ci,
...
var Si = class {
		...
		encode(e) {
			return (e.type === Z.EVENT || e.type === Z.ACK) && hi(e)
				? this.encodeAsBinary({
		...
		decodeString(t) {
			...
			if (r.type === Z.BINARY_EVENT || r.type === Z.BINARY_ACK) {
				...
				if (i != Number(i) || t.charAt(n) !== `-`)
					throw Error(`Illegal attachments`);
				let a = Number(i);
				if (!Ei(a) || a < 0) throw Error(`Illegal attachments`);
		...
		static isPayloadValid(e, t) {
			switch (e) {
				...
				case Z.CONNECT_ERROR:
					return typeof t == `string` || Oi(t);
				case Z.EVENT:
				case Z.BINARY_EVENT:
					return (
						Array.isArray(t) &&
						(typeof t[0] == `number` ||
							(typeof t[0] == `string` && xi.indexOf(t[0]) === -1))
					);
				case Z.ACK:
				case Z.BINARY_ACK:
	...
	wi = class {
		...
		takeBinaryData(e) {
			if (
				...
				let e = vi(this.reconPack, this.buffers);
...
function Ai(e) {
	return Ti(e.nsp) && Di(e.id) && ki(e.type, e.data);
}
function Q(e, t, n) {
	return (
		e.on(t, n),
	...
	Mi = class extends Y {
		...
		emit(e, ...t) {
			...
			let o =
				...
				s =
					this.connected &&
					!((i = this.io.engine) != null && i._hasPingExpired());
			return (
		...
		ack(e) {
			let t = this,
				n = !1;
			return function (...r) {
				n || ((n = !0), t.packet({ type: Z.ACK, id: e, data: r }));
			};
		}
		onack(e) {
...
var Pi = class extends Y {
		...
		open(e) {
			...
			this.engine = new si(this.uri, this.opts);
			let t = this.engine,
				n = this;
		...
		socket(e, t) {
			...
			return (
				n
					...
					: ((n = new Mi(this, e, t)), (this.nsps[e] = n)),
				n
			);
		}
		_destroy(e) {
...
function Ii(e, t) {
	...
	let n = ci(e, t.path || `/socket.io`),
		r = n.source,
		i = n.id,
		a = n.path,
		o = Fi[i] && a in Fi[i].nsps,
		s = t.forceNew || t[`force new connection`] || !1 === t.multiplex || o,
		c;
	return (
		s ? (c = new Pi(r, t)) : (Fi[i] || (Fi[i] = new Pi(r, t)), (c = Fi[i])),
		n.query && !t.query && (t.query = n.queryKey),
		c.socket(n.path, t)
	);
}
Object.assign(Ii, { Manager: Pi, Socket: Mi, io: Ii, connect: Ii });
function Li(e = {}) {
	let t = window.location.hostname,
		n = window.site_name,
		r = e.port || 9e3,
		i = window.location.port ? `:${r}` : ``;
	return Ii(`${i ? `http` : `https`}://${t}${i}/${n}`, { withCredentials: !0 });
}
var Ri = { resources: !0, call: !0, socketio: !0 },
	zi = {
		install(e, t = {}) {
			if (
				((t = Object.assign({}, Ri, t)),
				t.resources && e.use(Ue, t.resources),
				t.call)
			) {
				let n = typeof t.call == `function` ? t.call : Yn;
				e.config.globalProperties.$call = n;
			}
			t.socketio && (e.config.globalProperties.$socket = Li(t.socketio));
		},
	};
function Bi() {
	let e = new URLSearchParams(document.cookie.split(`; `).join(`&`)).get(
		`user_id`
	);
	return !e || e === `Guest` ? null : e;
}
function Vi(e) {
	e.message === `Logged In` && ((Hi.user = Bi()), Ui.replace({ name: `Home` }));
}
var Hi = E({
		user: Bi(),
		isLoggedIn: S(() => !!Hi.user),
		login: (function () {
			var e = T(function* (e, t) {
				let n = yield Yn(`login`, { usr: e, pwd: t });
				return Vi(n), n;
			});
			return function (t, n) {
				return e.apply(this, arguments);
		...
		routes: [
			{
				...
				name: `Home`,
				component: () =>
					Jn(() => import(`./Home-_sYUadsn.js`), __vite__mapDeps([0, 1, 2, 3])),
			},
			{
				path: `/login`,
				name: `Login`,
				component: () =>
					Jn(() => import(`./Login-CJLaZqwg.js`), __vite__mapDeps([4, 1])),
				meta: { isGuestRoute: !0 },
			},
			{
				path: `/vehicle-map`,
...
Ui.beforeEach((e, t, n) => {
	var r;
	let i = Hi.isLoggedIn;
	if (!i && !((r = e.meta) != null && r.isGuestRoute))
		return n({ name: `Login` });
	if (i && e.name === `Login`) return n({ name: `Home` });
	n();
});
var Wi = {},
	Gi = { id: `stride-app`, class: `min-h-screen bg-gray-50` };
function Ki(e, t) {
	let r = re(`router-view`);
	return n(), f(`div`, Gi, [k(r)]);
}
var $ = b(ae(Wi, [[`render`, Ki]]));
xe(`resourceFetcher`, Zn),
	$.use(zi),
	$.use(Ui),
	$.component(`Button`, Un),
	$.component(`Badge`, Wn),
	$.component(`FeatherIcon`, Ke),
	$.provide(`$session`, Hi),
	`serviceWorker` in navigator &&
		navigator.serviceWorker
			...
			.catch((e) =>
				console.error(`[Stride] Service worker registration failed:`, e)
			),
	$.mount(`#app`);
export { Ke as n, F as r, Un as t };
//# sourceMappingURL=index-lXaXi-wZ.js.map
