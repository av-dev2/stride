...
import { r as x } from "./index-lXaXi-wZ.js";
var S = l(
		y((e, t) => {
			(function (n, r) {
				...
				function i(e, t) {
					...
					return function () {
						return e.apply(
							t,
							r.length ? r.concat(n.call(arguments)) : arguments
						);
					};
				}
				var a = 0;
				...
				function s(e, t, n) {
					var r,
						...
						a,
						o = function () {
							(r = !1), i && (a.apply(n, i), (i = !1));
						};
					return (
						(a = function () {
							r
								? (i = arguments)
								: (e.apply(n, arguments), setTimeout(o, t), (r = !0));
						}),
						a
					);
				}
				...
				function u(e, t) {
					if (t === !1) return e;
					var n = Math.pow(10, t === void 0 ? 6 : t);
				...
				var b =
						window.requestAnimationFrame || te(`RequestAnimationFrame`) || ne,
					re =
				...
				(C.extend = function (e) {
					...
					return (
						...
						e.includes &&
							(ae(e.includes), n.apply(null, [a].concat(e.includes))),
						n(a, e),
						delete a.statics,
						delete a.includes,
						a.options &&
							((a.options = i.options ? r(i.options) : {}),
							n(a.options, e.options)),
						(a._initHooks = []),
				...
				var w = {
					...
					off: function (e, t, n) {
						if (!arguments.length) delete this._events;
							...
							for (var r in e) this._off(r, e[r], t);
						else {
							e = f(e);
							for (
								var i = arguments.length === 1, a = 0, o = e.length;
								a < o;
								a++
							)
						...
						if (this._events && ((r = this._events[e]), r)) {
							if (arguments.length === 1) {
								if (this._firingCount)
									for (i = 0, a = r.length; i < a; i++) r[i].fn = l;
							...
							if (o !== !1) {
								var s = r[o];
								this._firingCount &&
									((s.fn = l), (this._events[e] = r = r.slice())),
									r.splice(o, 1);
							}
						}
					},
				...
				D.prototype = {
					extend: function (e) {
						var t, n;
						if (!e) return this;
						if (e instanceof T || typeof e[0] == `number` || `x` in e)
							t = n = E(e);
						else if (((e = O(e)), (t = e.min), (n = e.max), !t || !n))
							return this;
						return (
							!this.min && !this.max
				...
				k.prototype = {
					extend: function (e) {
						...
						if (e instanceof j) (r = e), (i = e);
							...
							if (((r = e._southWest), (i = e._northEast), !r || !i))
								return this;
						} else return e ? this.extend(M(e) || A(e)) : this;
						return (
							!t && !n
								? ((this._southWest = new j(r.lat, r.lng)),
					...
					pad: function (e) {
						...
						return new k(
							new j(t.lat - r, t.lng - i),
							new j(n.lat + r, n.lng + i)
						);
					},
					getCenter: function () {
						return new j(
					...
					contains: function (e) {
						e =
							typeof e[0] == `number` || e instanceof j || `lat` in e
								? M(e)
								: A(e);
						var t = this._southWest,
							n = this._northEast,
						...
						return (
							e instanceof k
								? ((r = e.getSouthWest()), (i = e.getNorthEast()))
								: (r = i = e),
							r.lat >= t.lat &&
								i.lat <= n.lat &&
								r.lng >= t.lng &&
				...
				var N = {
						...
						wrapLatLngBounds: function (e) {
							...
							var a = e.getSouthWest(),
								o = e.getNorthEast();
							return new k(
								new j(a.lat - r, a.lng - i),
								new j(o.lat - r, o.lng - i)
							);
						},
					},
					ce = n({}, N, {
				...
				var pe = n({}, ce, {
						...
						transformation: (function () {
							var e = 0.5 / (Math.PI * ue.R);
							return fe(e, 0.5, -e, 0.5);
						})(),
					}),
				...
				var _e = document.documentElement.style,
					ve = `ActiveXObject` in window,
					ye = ve && !document.addEventListener,
					be = `msLaunchUri` in navigator && !(`documentMode` in document),
					xe = P(`webkit`),
					Se = P(`android`),
					Ce = P(`android 2`) || P(`android 3`),
					we = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
					Te = Se && P(`Google`) && we < 537 && !(`AudioNode` in window),
					Ee = !!window.opera,
					De = !be && P(`chrome`),
					Oe = P(`gecko`) && !xe && !Ee && !ve,
					ke = !De && P(`safari`),
					Ae = P(`phantom`),
					je = `OTransition` in _e,
					Me = navigator.platform.indexOf(`Win`) === 0,
					Ne = ve && `transition` in _e,
					Pe =
						`WebKitCSSMatrix` in window &&
						`m11` in new window.WebKitCSSMatrix() &&
						!Ce,
					Fe = `MozPerspective` in _e,
					Ie = !window.L_DISABLE_3D && (Ne || Pe || Fe) && !je && !Ae,
					Le = typeof orientation < `u` || P(`mobile`),
					Re = Le && xe,
					ze = Le && Pe,
					Be = !window.PointerEvent && window.MSPointerEvent,
					Ve = !!(window.PointerEvent || Be),
					He = `ontouchstart` in window || !!window.TouchEvent,
					Ue = !window.L_NO_TOUCH && (He || Ve),
					We = Le && Ee,
					Ge = Le && Oe,
					Ke =
					...
					Ye = !!(document.createElementNS && he(`svg`).createSVGRect),
					Xe =
						!!Ye &&
						(function () {
					...
					Qe = navigator.platform.indexOf(`Mac`) === 0,
					$e = navigator.platform.indexOf(`Linux`) === 0;
				function P(e) {
				...
				var F = {
					...
					et = F.msPointer ? `MSPointerDown` : `pointerdown`,
					tt = F.msPointer ? `MSPointerMove` : `pointermove`,
					nt = F.msPointer ? `MSPointerUp` : `pointerup`,
					rt = F.msPointer ? `MSPointerCancel` : `pointercancel`,
					it = { touchstart: et, touchmove: tt, touchend: nt, touchcancel: rt },
					at = { touchstart: ht, touchmove: mt, touchend: mt, touchcancel: mt },
					ot = {},
					st = !1;
				function ct(e, t, n) {
					return (
						t === `touchstart` && pt(),
						at[t]
							? ((n = at[t].bind(this, n)), e.addEventListener(it[t], n, !1), n)
				...
				function pt() {
					st ||
						...
						document.addEventListener(tt, dt, !0),
						document.addEventListener(nt, ft, !0),
				...
				function z(e, t) {
					if (e.classList !== void 0)
						for (var n = f(t), r = 0, i = n.length; r < i; r++)
							e.classList.add(n[r]);
					else if (!Ot(e, t)) {
						var a = At(e);
						kt(e, (a ? a + ` ` : ``) + t);
				...
				function Ut(e) {
					...
					e.style &&
						(Wt(),
						(Vt = e),
						(Ht = e.style.outlineStyle),
						(e.style.outlineStyle = `none`),
						U(window, `keydown`, Wt));
				}
				function Wt() {
					Vt &&
						((Vt.style.outlineStyle = Ht),
						(Vt = void 0),
						(Ht = void 0),
						G(window, `keydown`, Wt));
				}
				...
				function Xt(e, t, n, r) {
					...
					var a = function (t) {
						...
						s = a;
					!F.touchNative && F.pointer && t.indexOf(`touch`) === 0
						? (a = ct(e, t, a))
						: F.touch && t === `dblclick`
						? (a = vt(e, a))
						...
						? t === `touchstart` ||
						  ...
						  t === `mousewheel`
							...
							? ((a = function (t) {
									(t = t || window.event), sn(e, t) && s(t);
							  }),
							  e.addEventListener(Yt[t], a, !1))
				...
				function Zt(e, t, n, r, i) {
					...
					!F.touchNative && F.pointer && t.indexOf(`touch`) === 0
						...
						? e.removeEventListener(Yt[t] || t, a, !1)
				...
				function en(e) {
					return (
						U(e, `mousedown touchstart dblclick contextmenu`, Qt),
				...
				var cn = {
					...
					q = oe.extend({
						...
						initialize: function (e, t) {
							(t = p(this, t)),
								...
								this._zoomAnimated &&
									...
									U(this._proxy, St, this._catchTransitionEnd, this)),
						...
						setView: function (e, t, r) {
							return (
								...
								(r.animate !== void 0 &&
									...
									(r.pan = n(
										{ animate: r.animate, duration: r.duration },
										r.pan
									))),
								this._zoom === t
									? this._tryAnimatedPan(e, r.pan)
									: this._tryAnimatedZoom &&
									  this._tryAnimatedZoom(e, t, r.zoom))
						...
						zoomIn: function (e, t) {
							return (
								(e = e || (F.any3d ? this.options.zoomDelta : 1)),
							...
							function b() {
								...
								n <= 1
									? ((this._flyToFrame = x(b, this)),
									  this._move(
											this.unproject(
												r.add(i.subtract(r).multiplyBy(ee(a) / l)),
												o
											),
							...
							return (
								e.watch
									? (this._locationWatchId =
											navigator.geolocation.watchPosition(t, r, e))
						...
						_handleGeolocationResponse: function (e) {
							if (this._container._leaflet_id) {
								...
								for (var c in e.coords)
									typeof e.coords[c] == `number` && (s[c] = e.coords[c]);
						...
						addHandler: function (e, t) {
							...
							return (
								this._handlers.push(n), this.options[e] && n.enable(), this
							);
						},
						remove: function () {
							if (
							...
							for (var e in (this._locationWatchId !== void 0 &&
								this.stopLocate(),
							this._stop(),
							R(this._mapPane),
						...
						getBoundsZoom: function (e, t, n) {
							...
							var r = this.getZoom() || 0,
								...
								u = F.any3d ? this.options.zoomSnap : 1,
								d = c.x / l.x,
								f = c.y / l.y,
						...
						getZoomScale: function (e, t) {
							...
							return (
								(t = t === void 0 ? this._zoom : t), n.scale(e) / n.scale(t)
							);
						},
						...
						unproject: function (e, t) {
							return (
								(t = t === void 0 ? this._zoom : t),
								this.options.crs.pointToLatLng(E(e), t)
							);
						},
						...
						_findEventTargets: function (e, t) {
							...
							return (
								!n.length && !s && !i && this.listens(t, !0) && (n = [this]), n
							);
						},
								...
								for (s = 0; s < a.length; s++)
									if (
										...
										l.originalEvent._stopped ||
											(a[s].options.bubblingMouseEvents === !1 &&
												ee(this._mouseEvents, t) !== -1))
									)
										return;
							}
						},
						...
						_getMapPanePos: function () {
							return Pt(this._mapPane) || new T(0, 0);
						},
						_moved: function () {
							var e = this._getMapPanePos();
						...
						_limitCenter: function (e, t, n) {
							...
							return Math.abs(o.x) <= 1 && Math.abs(o.y) <= 1
								? e
								: this.unproject(r.add(o), t);
						},
						...
						_limitZoom: function (e) {
							var t = this.getMinZoom(),
								n = this.getMaxZoom(),
								r = F.any3d ? this.options.zoomSnap : 1;
							return (
								r && (e = Math.round(e / r) * r), Math.max(t, Math.min(n, e))
							);
						},
						...
						_onZoomTransitionEnd: function () {
							this._animatingZoom &&
								(this._mapPane && B(this._mapPane, `leaflet-zoom-anim`),
				...
				var fn = J.extend({
						...
						addTo: function (e) {
							return (
								J.prototype.addTo.call(this, e), this._expandIfNotCollapsed()
							);
						},
						onRemove: function () {
						...
						expand: function () {
							...
							return (
								e < this._section.clientHeight
									...
									: B(this._section, `leaflet-control-layers-scrollbar`),
						...
						collapse: function () {
							return (
								B(this._container, `leaflet-control-layers-expanded`), this
							);
						},
						_initLayout: function () {
							var e = `leaflet-control-layers`,
								t = (this._container = I(`div`, e)),
							...
							(i.href = `#`),
								...
								n || this.expand(),
								(this._baseLayersList = I(`div`, e + `-base`, r)),
								(this._separator = I(`div`, e + `-separator`, r)),
								(this._overlaysList = I(`div`, e + `-overlays`, r)),
								t.appendChild(r);
						},
						_getLayer: function (e) {
							for (var t = 0; t < this._layers.length; t++)
								if (this._layers[t] && o(this._layers[t].layer) === e)
						...
						_update: function () {
							...
							Tt(this._baseLayersList),
								Tt(this._overlaysList),
								(this._layerControlInputs = []);
							var e,
								t,
								n,
						...
						_addItem: function (e) {
							...
							e.overlay
								...
								: (r = this._createRadioElement(
										`leaflet-base-layers_` + o(this),
										n
								  )),
								this._layerControlInputs.push(r),
								(r.layerId = o(e.layer)),
								U(r, `click`, this._onInputClick, this);
						...
						_onInputClick: function () {
							if (!this._preventClick) {
								...
								for (a = 0; a < r.length; a++)
									this._map.hasLayer(r[a]) || this._map.addLayer(r[a]);
					...
					mn = J.extend({
						...
						_createButton: function (e, t, n, r, i) {
							...
							return (
								...
								U(a, `click`, tn),
								U(a, `click`, i, this),
								U(a, `click`, this._refocusOnMap, this),
								a
							);
						},
						_updateDisabled: function () {
							var e = this._map,
								t = `leaflet-disabled`;
							B(this._zoomInButton, t),
								B(this._zoomOutButton, t),
				...
				q.mergeOptions({ zoomControl: !0 }),
					q.addInitHook(function () {
						this.options.zoomControl &&
							((this.zoomControl = new mn()),
				...
				var hn = function (e) {
					...
					gn = J.extend({
						...
						_addScales: function (e, t, n) {
							e.metric && (this._mScale = I(`div`, t, n)),
								e.imperial && (this._iScale = I(`div`, t, n));
						},
						_update: function () {
							var e = this._map,
								t = e.getSize().y / 2,
					...
					vn = J.extend({
						...
						onAdd: function (e) {
							...
							(this._container = I(`div`, `leaflet-control-attribution`)),
							en(this._container),
							e._layers))
				...
				q.mergeOptions({ attributionControl: !0 }),
					q.addInitHook(function () {
				...
				var yn = { Events: w },
					bn = F.touch ? `touchstart mousedown` : `mousedown`,
					xn = oe.extend({
						...
						enable: function () {
							this._enabled ||
								(U(this._dragStartTarget, bn, this._onDown, this),
								(this._enabled = !0));
						},
						disable: function () {
							this._enabled &&
								(xn._dragging === this && this.finishDrag(!0),
								G(this._dragStartTarget, bn, this._onDown, this),
								(this._enabled = !1),
								(this._moved = !1));
						},
						_onDown: function (e) {
							if (
								this._enabled &&
								((this._moved = !1), !Ot(this._element, `leaflet-zoom-anim`))
							) {
								...
								if (
									...
									((xn._dragging = this),
									this._preventOutline && Ut(this._element),
									zt(),
									Ft(),
									!this._moving)
								) {
						...
						finishDrag: function (e) {
							B(document.body, `leaflet-dragging`),
								...
								G(document, `mousemove touchmove`, this._onMove, this),
								G(document, `mouseup touchend touchcancel`, this._onUp, this),
								Bt(),
								It();
					...
					for (s = 0; s < 4; s++) {
						for (
							...
							(c = e[a]),
								...
								c._code & d
									? l._code & d ||
									  ((f = Pn(l, c, d, t, n)), (f._code = Fn(f, t)), r.push(f))
									: (l._code & d &&
											((f = Pn(l, c, d, t, n)),
											(f._code = Fn(f, t)),
											r.push(f)),
				...
				function An(e, t, n, r, i) {
					var a = 0,
						...
						c;
					for (s = r + 1; s <= i - 1; s++)
						(c = Ln(e[s], e[r], e[i], !0)), c > a && ((o = s), (a = c));
				...
				var Bn = {
					...
					Hn = {
						...
						project: function (e) {
							...
							return (
								(r = -n * Math.log(Math.max(s, 1e-10))), new T(e.lng * t * n, r)
							);
						},
						unproject: function (e) {
							for (
				...
				var qn = Z.extend({
						...
						hasLayer: function (e) {
							return (
								(typeof e == `number` ? e : this.getLayerId(e)) in this._layers
							);
						},
						...
						invoke: function (e) {
							...
							for (n in this._layers)
								(r = this._layers[n]), r[e] && r[e].apply(r, t);
							return this;
						},
						onAdd: function (e) {
					...
					Xn = C.extend({
						...
						_getIconUrl: function (e) {
							return (
								(F.retina && this.options[e + `RetinaUrl`]) ||
								this.options[e + `Url`]
							);
						},
					});
				...
				var Qn = Xn.extend({
						...
						_getIconUrl: function (e) {
							return (
								typeof Qn.imagePath != `string` &&
									(Qn.imagePath = this._detectIconPath()),
								(this.options.imagePath || Qn.imagePath) +
									Xn.prototype._getIconUrl.call(this, e)
							);
						},
						...
						_detectIconPath: function () {
							var e = I(`div`, `leaflet-default-icon-path`, document.body),
								t = wt(e, `background-image`) || wt(e, `backgroundImage`);
					...
					$n = Y.extend({
						...
						addHooks: function () {
							...
							this._draggable || (this._draggable = new xn(e, e, !0)),
								this._draggable
									.on(
										{
						...
						removeHooks: function () {
							this._draggable
								...
								.disable(),
								this._marker._icon &&
									B(this._marker._icon, `leaflet-marker-draggable`);
						},
						moved: function () {
						...
						_adjustPan: function (e) {
							var t = this._marker,
								...
								s = n.getPixelOrigin(),
								c = O(
									o.min._subtract(s).add(i),
									o.max._subtract(s).subtract(i)
								);
							if (!c.contains(a)) {
								var l = E(
								...
								n.panBy(l, { animate: !1 }),
									...
									H(t._icon, this._draggable._newPos),
									this._onDrag(e),
					...
					er = Z.extend({
						...
						_initIcon: function () {
							...
							n !== this._icon &&
								...
								this.options.autoPanOnFocus &&
									U(n, `focus`, this._panOnFocus, this);
						...
						_removeIcon: function () {
							this.options.riseOnHover &&
								...
								this.options.autoPanOnFocus &&
									G(this._icon, `focus`, this._panOnFocus, this),
								R(this._icon),
						...
						_setPos: function (e) {
							this._icon && H(this._icon, e),
								this._shadow && H(this._shadow, e),
						...
						_updateOpacity: function () {
							...
							this._icon && V(this._icon, e),
								this._shadow && V(this._shadow, e);
						},
				...
				var nr = Z.extend({
					...
					rr = nr.extend({
						...
						setStyle: function (e) {
							...
							return (
								nr.prototype.setStyle.call(this, e), this.setRadius(t), this
							);
						},
						_project: function () {
				...
				var sr = nr.extend({
					...
					_convertLatLngs: function (e) {
						for (var t = [], n = X(e), r = 0, i = e.length; r < i; r++)
							n
								? ((t[r] = M(e[r])), this._bounds.extend(t[r]))
					...
					_containsPoint: function (e, t) {
						...
						for (n = 0, a = this._parts.length; n < a; n++)
							for (
								s = this._parts[n], r = 0, o = s.length, i = o - 1;
								r < o;
								i = r++
							)
								if (!(!t && r === 0) && Dn(e, s[i], s[r]) <= c) return !0;
						return !1;
					},
				});
				function cr(e, t) {
				...
				var lr = sr.extend({
					...
					_convertLatLngs: function (e) {
						var t = sr.prototype._convertLatLngs.call(this, e),
							n = t.length;
						return (
							n >= 2 && t[0] instanceof j && t[0].equals(t[n - 1]) && t.pop(), t
						);
					},
					_setLatLngs: function (e) {
						sr.prototype._setLatLngs.call(this, e),
					...
					_containsPoint: function (e) {
						...
						for (a = 0, c = this._parts.length; a < c; a++)
							for (
								n = this._parts[a], o = 0, l = n.length, s = l - 1;
								o < l;
								s = o++
							)
								(r = n[o]),
				...
				var dr = Q.extend({
					...
					_setLayerStyle: function (e, t) {
						e.setStyle &&
							(typeof t == `function` && (t = t(e.feature)), e.setStyle(t));
					},
				});
				function fr(e, t) {
					...
					switch (n.type) {
						case `Point`:
							return (s = o(r)), pr(a, e, s, t);
						case `MultiPoint`:
							for (l = 0, u = r.length; l < u; l++)
								(s = o(r[l])), i.push(pr(a, e, s, t));
							return new Q(i);
						case `LineString`:
						case `MultiLineString`:
							return (
								(c = hr(r, n.type === `LineString` ? 0 : 1, o)), new sr(c, t)
							);
						case `Polygon`:
						case `MultiPolygon`:
							return (c = hr(r, n.type === `Polygon` ? 1 : 2, o)), new lr(c, t);
				...
				function hr(e, t, n) {
					for (var r = [], i = 0, a = e.length, o; i < a; i++)
						(o = t ? hr(e[i], t - 1, n) : (n || mr)(e[i])), r.push(o);
					return r;
				}
				function gr(e, t) {
					return (
				...
				function _r(e, t, n, r) {
					for (var i = [], a = 0, o = e.length; a < o; a++)
						i.push(t ? _r(e[a], X(e[a]) ? 0 : t - 1, n, r) : gr(e[a], r));
				...
				er.include(br),
					...
					sr.include({
						toGeoJSON: function (e) {
							var t = !X(this._latlngs),
								n = _r(this._latlngs, +!!t, !1, e);
							return vr(this, {
					...
					lr.include({
						toGeoJSON: function (e) {
							var t = !X(this._latlngs),
								n = t && !X(this._latlngs[0]),
								r = _r(this._latlngs, n ? 2 : +!!t, !0, e);
							return (
								t || (r = [r]),
								vr(this, {
					...
					qn.include({
						toMultiPoint: function (e) {
							...
							return (
								...
								vr(this, { type: `MultiPoint`, coordinates: t })
							);
						},
						toGeoJSON: function (e) {
							var t =
									...
									if (t.toGeoJSON) {
										...
										if (n) r.push(i.geometry);
											...
											a.type === `FeatureCollection`
												? r.push.apply(r, a.features)
												: r.push(a);
										}
									}
								}),
								n
									? vr(this, { geometries: r, type: `GeometryCollection` })
					...
					Cr = Z.extend({
						...
						_initImage: function () {
							var e = this._url.tagName === `IMG`,
								t = (this._image = e ? this._url : I(`img`));
							if (
					...
					Tr = Cr.extend({
						...
						_initImage: function () {
							var e = this._url.tagName === `VIDEO`,
								t = (this._image = e ? this._url : I(`video`));
							if (
								(z(t, `leaflet-image-layer`),
								this._zoomAnimated && z(t, `leaflet-zoom-animated`),
								this.options.className && z(t, this.options.className),
								...
								for (
									var n = t.getElementsByTagName(`source`), r = [], a = 0;
									a < n.length;
									a++
								)
									r.push(n[a].src);
				...
				var $ = Z.extend({
					...
					onAdd: function (e) {
						(this._zoomAnimated = e._zoomAnimated),
							...
							e._fadeAnimated && V(this._container, 0),
							clearTimeout(this._removeTimeout),
							this.getPane().appendChild(this._container),
							this.update(),
							e._fadeAnimated && V(this._container, 1),
							this.bringToFront(),
							this.options.interactive &&
				...
				var kr = $.extend({
						...
						onAdd: function (e) {
							$.prototype.onAdd.call(this, e),
								...
								this._source &&
									...
									this._source instanceof nr ||
										this._source.on(`preclick`, Qt));
						},
						onRemove: function (e) {
							$.prototype.onRemove.call(this, e),
								e.fire(`popupclose`, { popup: this }),
								this._source &&
									(this._source.fire(`popupclose`, { popup: this }, !0),
									this._source instanceof nr ||
										this._source.off(`preclick`, Qt));
						},
						getEvents: function () {
						...
						_initLayout: function () {
							var e = `leaflet-popup`,
								...
								n = (this._wrapper = I(`div`, e + `-content-wrapper`, t));
							if (
								((this._contentNode = I(`div`, e + `-content`, n)),
								en(t),
								$t(this._contentNode),
								U(t, `contextmenu`, Qt),
								(this._tipContainer = I(`div`, e + `-tip-container`, t)),
								(this._tip = I(`div`, e + `-tip`, this._tipContainer)),
						...
						_updateLayout: function () {
							...
							i && r > i ? ((t.height = i + `px`), z(e, a)) : B(e, a),
						...
						_adjustPan: function () {
							if (this.options.autoPan) {
								...
								var e = this._map,
									t = parseInt(wt(this._container, `marginBottom`), 10) || 0,
				...
				q.mergeOptions({ closePopupOnClick: !0 }),
					q.include({
					...
					Z.include({
						...
						openPopup: function (e) {
							return (
								this._popup &&
									(this instanceof Q || (this._popup._source = this),
				...
				var jr = $.extend({
						...
						_initLayout: function () {
							...
							(this._contentNode = this._container = I(`div`, e)),
								this._container.setAttribute(`role`, `tooltip`),
								this._container.setAttribute(
									`id`,
									`leaflet-tooltip-` + o(this)
								);
						},
						_updateLayout: function () {},
						_adjustPan: function () {},
						_setPosition: function (e) {
							...
							s === `top`
								...
								(e = e.subtract(E(t, n, !0)).add(u).add(d)),
								B(i, `leaflet-tooltip-right`),
								B(i, `leaflet-tooltip-left`),
								B(i, `leaflet-tooltip-top`),
								B(i, `leaflet-tooltip-bottom`),
								z(i, `leaflet-tooltip-` + s),
								H(i, e);
						},
						_updatePosition: function () {
							var e = this._map.latLngToLayerPoint(this._latlng);
						...
						setOpacity: function (e) {
							(this.options.opacity = e),
								this._container && V(this._container, e);
						},
						_animateZoom: function (e) {
							var t = this._map._latLngToNewLayerPoint(
								this._latlng,
				...
				q.include({
					...
					Z.include({
						...
						openTooltip: function (e) {
							return (
								this._tooltip &&
									(this instanceof Q || (this._tooltip._source = this),
						...
						_addFocusListenersOnLayer: function (e) {
							...
							t &&
								...
								U(t, `blur`, this.closeTooltip, this));
						},
				...
				var Nr = Xn.extend({
					...
					createIcon: function (e) {
						var t =
								e && e.tagName === `DIV` ? e : document.createElement(`div`),
							n = this.options;
						if (
							(n.html instanceof Element
								? (Tt(t), t.appendChild(n.html))
				...
				var Fr = Z.extend({
					...
					bringToFront: function () {
						return (
							this._map && (Et(this._container), this._setAutoZIndex(Math.max)),
							this
						);
					},
					bringToBack: function () {
						return (
							this._map && (Dt(this._container), this._setAutoZIndex(Math.min)),
							this
						);
					},
					getContainer: function () {
					...
					_setAutoZIndex: function (e) {
						for (
							...
							(a = t[r].style.zIndex),
								t[r] !== this._container && a && (n = e(n, +a));
						isFinite(n) &&
							((this.options.zIndex = n + e(-1, 1)), this._updateZIndex());
					},
					_updateOpacity: function () {
					...
					_retainParent: function (e, t, n, r) {
						...
						return l && l.active
							...
							: (l && l.loaded && (l.retain = !0),
							  o > r ? this._retainParent(i, a, o, r) : !1);
					},
					...
					_update: function (e) {
						...
						if (t) {
							...
							if (
								(e === void 0 && (e = t.getCenter()), this._tileZoom !== void 0)
							) {
					...
					_initTile: function (e) {
						...
						(e.style.width = t.x + `px`),
							...
							(e.onselectstart = l),
							(e.onmousemove = l),
							F.ielt9 && this.options.opacity < 1 && V(e, this.options.opacity);
					},
					_addTile: function (e, t) {
						...
						this._initTile(a),
							this.createTile.length < 2 &&
								x(i(this._tileReady, this, e, null, a)),
							H(a, n),
				...
				var Lr = Fr.extend({
					...
					initialize: function (e, t) {
						(this._url = e),
							(t = p(this, t)),
							t.detectRetina && F.retina && t.maxZoom > 0
					...
					createTile: function (e, t) {
						...
						return (
							U(n, `load`, i(this._tileOnLoad, this, t, n)),
							U(n, `error`, i(this._tileOnError, this, t, n)),
							(this.options.crossOrigin || this.options.crossOrigin === ``) &&
								(n.crossOrigin =
									this.options.crossOrigin === !0
										? ``
				...
				var zr = Lr.extend({
					...
					initialize: function (e, t) {
						...
						t = p(this, t);
						var a = t.detectRetina && F.retina ? 2 : 1,
							o = this.getTileSize();
					...
					onAdd: function (e) {
						...
						(this.wmsParams[t] = this._crs.code),
							Lr.prototype.onAdd.call(this, e);
					},
					getTileUrl: function (e) {
						var t = this._tileCoordsToNwSe(e),
							n = this._crs,
				...
				var Vr = Z.extend({
					...
					Hr = Vr.extend({
						...
						_initContainer: function () {
							...
							U(e, `mousemove`, this._onMouseMove, this),
								U(
									e,
								...
								U(e, `mouseout`, this._handleMouseOut, this),
						...
						_handleMouseHover: function (e, t) {
							if (!this._mouseHoverThrottled) {
								for (var n, r, a = this._drawFirst; a; a = a.next)
									(n = a.layer),
										n.options.interactive && n._containsPoint(t) && (r = n);
				...
				var Wr = (function () {
					...
					Gr = {
						...
						_update: function () {
							this._map._animatingZoom ||
								(Vr.prototype._update.call(this), this.fire(`update`));
						},
						_initPath: function (e) {
							var t = (e._container = Wr(`shape`));
							z(t, `leaflet-vml-shape ` + (this.options.className || ``)),
								(t.coordsize = `1 1`),
								(e._path = Wr(`path`)),
				...
				(qr.create = Kr),
					(qr.pointsToPath = ge),
					(dr.geometryToLayer = fr),
					(dr.coordsToLatLng = mr),
					(dr.coordsToLatLngs = hr),
					(dr.latLngToCoords = gr),
					(dr.latLngsToCoords = _r),
					(dr.getFeature = vr),
					(dr.asFeature = yr),
					q.mergeOptions({ boxZoom: !0 });
				var Zr = Y.extend({
					initialize: function (e) {
						(this._map = e),
					...
					_onMouseMove: function (e) {
						this._moved ||
							((this._moved = !0),
							(this._box = I(`div`, `leaflet-zoom-box`, this._container)),
					...
					_finish: function () {
						this._moved &&
							(R(this._box), B(this._container, `leaflet-crosshair`)),
							It(),
							Bt(),
							G(
								document,
				...
				q.addInitHook(`addHandler`, `boxZoom`, Zr),
					q.mergeOptions({ doubleClickZoom: !0 });
				var Qr = Y.extend({
					addHooks: function () {
				...
				q.addInitHook(`addHandler`, `doubleClickZoom`, Qr),
					q.mergeOptions({
						dragging: !0,
						inertia: !0,
				...
				var $r = Y.extend({
					addHooks: function () {
						if (!this._draggable) {
							var e = this._map;
							(this._draggable = new xn(e._mapPane, e._container)),
								this._draggable.on(
									{
										dragstart: this._onDragStart,
										drag: this._onDrag,
					...
					removeHooks: function () {
						B(this._map._container, `leaflet-grab`),
							B(this._map._container, `leaflet-touch-drag`),
				...
				q.addInitHook(`addHandler`, `dragging`, $r),
					q.mergeOptions({ keyboard: !0, keyboardPanDelta: 80 });
				var ei = Y.extend({
					keyCodes: {
						left: [37],
						right: [39],
							...
							if (t in this._panKeys) {
								if (!n._panAnim || !n._panAnim._inProgress)
									if (
										...
										n.options.maxBounds &&
											(r = n._limitOffset(E(r), n.options.maxBounds)),
										n.options.worldCopyJump)
									) {
										var i = n.wrapLatLng(
											n.unproject(n.project(n.getCenter()).add(r))
										);
										n.panTo(i);
									} else n.panBy(r);
							} else if (t in this._zoomKeys)
								n.setZoom(
									n.getZoom() + (e.shiftKey ? 3 : 1) * this._zoomKeys[t]
								);
							else if (
								t === 27 &&
								n._popup &&
				...
				q.addInitHook(`addHandler`, `keyboard`, ei),
					q.mergeOptions({
						scrollWheelZoom: !0,
					...
					_onDown: function (e) {
						if ((clearTimeout(this._holdTimeout), e.touches.length === 1)) {
							...
							(this._startPos = this._newPos = new T(t.clientX, t.clientY)),
								...
								U(document, `touchmove`, this._onMove, this);
						}
					},
				...
				q.addInitHook(`addHandler`, `tapHold`, ri),
					q.mergeOptions({ touchZoom: F.touch, bounceAtZoomLimits: !0 });
				var ii = Y.extend({
					addHooks: function () {
					...
					_onTouchStart: function (e) {
						...
						if (
							...
							(this._centerPoint = t.getSize()._divideBy(2)),
								...
								U(document, `touchend touchcancel`, this._onTouchEnd, this),
								K(e);
						}
					},
					_onTouchMove: function (e) {
						if (!(!e.touches || e.touches.length !== 2 || !this._zooming)) {
							...
							(this._animRequest = x(s, this, !0)), K(e);
						}
					},
				...
				q.addInitHook(`addHandler`, `touchZoom`, ii),
					(q.BoxZoom = Zr),
					(q.DoubleClickZoom = Qr),
					(q.Drag = $r),
					(q.Keyboard = ei),
					(q.ScrollWheelZoom = ti),
					(q.TapHold = ri),
					(q.TouchZoom = ii),
					(e.Bounds = D),
					(e.Browser = F),
	...
	ie = re(
		{
			...
			setup(n, { expose: r, emit: a }) {
				let s = n,
					...
					d = {},
					f = null;
				delete S.default.Icon.Default.prototype._getIconUrl,
					S.default.Icon.Default.mergeOptions({
				...
				function _() {
					l.value &&
						((u = S.default
							.map(l.value, { zoomControl: !0, attributionControl: !0 })
						...
						S.default
							...
							.addTo(u),
						(f = S.default.layerGroup().addTo(u)));
				}
				function ee(e) {
					if (!u || !f) return;
					f.clearLayers(), (d = {});
					let t = [];
					e.forEach((e) => {
						let n = parseFloat(e.latitude),
							r = parseFloat(e.longitude);
						if (isNaN(n) || isNaN(r)) return;
						let i = [n, r];
						t.push(i);
						let a = h(e),
							o = g(e),
							s = S.default.circleMarker(i, {
								radius: 10,
								fillColor: a,
								color: `#fff`,
								weight: 2,
							...
							l = e.speed
								? `${parseFloat(e.speed).toFixed(1)} km/h`
								: `Stationary`,
							u = e.alert_type
								? `<div style="color:#e74c3c;font-weight:600;margin-top:6px;">
           ⚠️ ${e.alert_type}: ${e.alert_message || ``}
         </div>`
								: ``;
						s.bindPopup(`
      <div style="min-width:200px;font-size:13px;line-height:1.6;">
        <div style="font-weight:700;font-size:15px;margin-bottom:4px;">
          ${e.license_plate || e.vehicle}
        </div>
        <div style="color:#888;margin-bottom:6px;">
          ${e.make || ``} ${e.model || ``}
        </div>
        <div>📍 ${e.address || `${n.toFixed(5)}, ${r.toFixed(5)}`}</div>
        <div>🏎️ ${l}</div>
        <div>📡 Status: <strong style="color:${a};">${o}</strong></div>
        ${u}
        <div style="margin-top:8px;">
          <a href="/app/vehicle/${e.vehicle}"
    ...
    `),
							s.bindTooltip(e.license_plate || e.vehicle, {
								permanent: !1,
								direction: `top`,
								offset: [0, -12],
							}),
							s.on(`click`, () => {
								c(`vehicle-selected`, e.vehicle);
							}),
							s.addTo(f),
							(d[e.vehicle] = s);
					}),
						t.length > 0 && u.fitBounds(t, { padding: [50, 50], maxZoom: 15 });
				}
				function te(e) {
					if (!u) return;
					let t = d[e.vehicle];
					t && (u.setView(t.getLatLng(), 16, { animate: !0 }), t.openPopup());
				}
				return (
					r({ focusOnVehicle: te }),
					t(
					...
					t(
						...
						(e) => {
							if (e && d[e]) {
								let t = d[e];
								u.setView(t.getLatLng(), 16, { animate: !0 }), t.openPopup();
							}
						}
					),
					i(() => {
						m(() => {
							_(), s.locations.length && ee(s.locations);
						});
					}),
					p(() => {
						u && (u.remove(), (u = null));
					...
					(t, n) => (
						...
						o(
							`div`,
							{ ref_key: `mapContainer`, ref: l, class: `w-full h-full` },
							null,
							512
						)
					)
		...
		[[`__scopeId`, `data-v-d0a6c819`]]
	),
	C = { class: `flex flex-col h-screen` },
	ae = {
	...
	T = { class: `flex items-center gap-2 text-sm text-gray-600` },
	se = { class: `flex flex-1 overflow-hidden` },
	E = {
		class: `w-72 bg-white border-r border-gray-200 overflow-y-auto flex-shrink-0`,
	},
	D = { class: `p-3 border-b border-gray-100` },
	O = { key: 0, class: `p-4 text-center` },
	k = [`onClick`],
	A = { class: `flex items-center justify-between mb-1` },
	j = { class: `font-medium text-sm text-gray-900` },
	M = { class: `text-xs text-gray-500` },
	N = { class: `text-xs text-gray-400 mt-1` },
	ce = { class: `flex-1 relative` },
	le = {
		__name: `VehicleMap`,
		setup(l) {
			let m = v([]),
				...
				pe = _(() => m.value.length),
				me = _(() => m.value.filter((e) => e.alert_type).length),
				he = _(() => {
					if (!re.value) return m.value;
					let e = re.value.toLowerCase();
					return m.value.filter(
						(t) =>
							(t.license_plate || ``).toLowerCase().includes(e) ||
							(t.vehicle || ``).toLowerCase().includes(e) ||
							(t.make || ``).toLowerCase().includes(e) ||
			...
			function _e(e) {
				(S.value = e.vehicle), ue.value && ue.value.focusOnVehicle(e);
			}
			function ve(e) {
				S.value = e;
			}
			function ye(e) {
				return e.alert_type ? `🔴` : parseFloat(e.speed || 0) > 2 ? `🟢` : `🔵`;
			}
			function be(e) {
				return e
							...
							h(`div`, ae, [
								h(`div`, w, [
									ne(
										...
										{
											default: n(() => [
												ne(l, { name: `arrow-left`, class: `w-5 h-5` }),
											]),
											_: 1,
										}
									),
									...
									pe.value > 0
										? (e(),
										  f(
												_,
												{ key: 0, variant: `subtle`, theme: `blue` },
												{
													default: n(() => [
														c(
															d(pe.value) +
									...
									me.value > 0
										? (e(),
										  f(
												_,
												{ key: 1, variant: `subtle`, theme: `red` },
												{
													default: n(() => [
														c(
															d(me.value) +
											...
											(t) => (
												...
												o(
													`div`,
													{
														...
														onClick: (e) => _e(t),
														class: ee([
															`px-4 py-3 border-b border-gray-50 cursor-pointer hover:bg-blue-50 transition-colors`,
															{
													...
													[
														...
														h(`div`, M, d(t.make) + ` ` + d(t.model), 1),
														h(
															`div`,
															N,
															d(
																t.speed
																	? parseFloat(t.speed).toFixed(1) + ` km/h`
																	: `Idle`
															) +
																` · ` +
																d(be(t.timestamp)),
								...
								h(`div`, ce, [
									ne(
										ie,
										{
											...
											ref: ue,
											locations: m.value,
											"selected-vehicle": S.value,
											onVehicleSelected: ve,
										},
										null,
										8,
										[`locations`, `selected-vehicle`]
									),
								]),
							]),
						])
...
//# sourceMappingURL=VehicleMap-B7d-fsYW.js.map
