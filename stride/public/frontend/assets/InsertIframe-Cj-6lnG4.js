...
import { t as j } from "./debounce-dtZa6gl9.js";
import { n as M, t as N } from "./_plugin-vue_export-helper-DOrAluW7.js";
import {
	O as P,
	c as F,
	d as I,
...
import { i as V, n as ne, r as re, t as ie } from "./FocusScope-IRrUVxOh.js";
import { n as ae, t as H } from "./index-lXaXi-wZ.js";
var oe = {
		inheritAttrs: !1,
		render() {
			return l(
	...
	ce = c({
		...
		setup(e, { emit: t }) {
			...
			return (
				...
				(e, t) =>
					s(e.$slots, `default`, { open: m(r), close: () => (r.value = !1) })
			);
		},
	}),
	le = c({
			...
			return (t, a) => (
				...
				_(
					...
					o(r, {
						...
						onClick: a[0] || (a[0] = (e) => m(i).onOpenChange(!1)),
					}),
					{ default: n(() => [s(t.$slots, `default`)]), _: 3 },
					16,
					[`type`]
				)
			);
...
var G = c({
		...
		setup(t, { emit: r }) {
			let a = t,
				c = r,
				l = U(),
				{ forwardRef: u, currentElement: d } = z();
			return (
				l.titleId || (l.titleId = L(void 0, `reka-dialog-title`)),
				l.descriptionId ||
					(l.descriptionId = L(void 0, `reka-dialog-description`)),
				i(() => {
					(l.contentElement = d),
						V() !== document.body && (l.triggerElement.value = V());
				}),
				(t, r) => (
					e(),
					_(
						m(ie),
						{
							...
							loop: ``,
							trapped: a.trapFocus,
							onMountAutoFocus: r[5] || (r[5] = (e) => c(`openAutoFocus`, e)),
							onUnmountAutoFocus:
								r[6] || (r[6] = (e) => c(`closeAutoFocus`, e)),
						},
						{
							default: n(() => [
								A(
									...
									o(
										{
											...
											role: `dialog`,
											"aria-describedby": m(l).descriptionId,
											"aria-labelledby": m(l).titleId,
											"data-state": m(fe)(m(l).open.value),
										},
										t.$attrs,
										{
											onDismiss: r[0] || (r[0] = (e) => m(l).onOpenChange(!1)),
											onEscapeKeyDown:
												r[1] || (r[1] = (e) => c(`escapeKeyDown`, e)),
											onFocusOutside:
												r[2] || (r[2] = (e) => c(`focusOutside`, e)),
											onInteractOutside:
												r[3] || (r[3] = (e) => c(`interactOutside`, e)),
											onPointerDownOutside:
												r[4] || (r[4] = (e) => c(`pointerDownOutside`, e)),
										}
									),
									{ default: n(() => [s(t.$slots, `default`)]), _: 3 },
									16,
							...
							onCloseAutoFocus:
								...
								(r[0] = (e) => {
									if (!e.defaultPrevented) {
										var t;
										e.preventDefault(),
											(t = m(c).triggerElement.value) == null || t.focus();
									}
								}),
							onPointerDownOutside:
								r[1] ||
					...
					o(M(M({}, i), m(a)), {
						...
						onCloseAutoFocus:
							...
							(r[0] = (e) => {
								if (!e.defaultPrevented) {
									var t;
									l.value ||
										(t = m(c).triggerElement.value) == null ||
										t.focus(),
										e.preventDefault();
								}
								(l.value = !1), (u.value = !1);
						...
						onInteractOutside:
							...
							(r[1] = (e) => {
								...
								e.defaultPrevented ||
									((l.value = !0),
									e.detail.originalEvent.type === `pointerdown` &&
										(u.value = !0));
								let n = e.target;
								(t = m(c).triggerElement.value) != null &&
									t.contains(n) &&
	...
	he = c({
		...
		setup(t, { emit: r }) {
			...
			return (t, r) => (
				...
				_(
					m(I),
					{ present: t.forceMount || m(c).open.value },
					{
						default: n(() => [
							m(c).modal.value
								? (e(),
								  _(
										pe,
										o({ key: 0, ref: m(u) }, M(M(M({}, i), m(l)), t.$attrs)),
										{ default: n(() => [s(t.$slots, `default`)]), _: 3 },
										16
								  ))
								: (e(),
								  _(
										me,
										o({ key: 1, ref: m(u) }, M(M(M({}, i), m(l)), t.$attrs)),
										{ default: n(() => [s(t.$slots, `default`)]), _: 3 },
										16
								  )),
						]),
	...
	_e = c({
		...
		setup(t) {
			...
			return (t, a) => {
				var c;
				return (c = m(r)) != null && c.modal.value
					? (e(),
					  _(
							m(I),
							{ key: 0, present: t.forceMount || m(r).open.value },
							{
								default: n(() => [
									A(
										ge,
										o(t.$attrs, { ref: m(i), as: t.as, "as-child": t.asChild }),
										{ default: n(() => [s(t.$slots, `default`)]), _: 3 },
										16,
										[`as`, `as-child`]
									),
	...
	ye = { class: `bg-surface-modal px-4 pb-6 pt-5 sm:px-6` },
	be = { class: `flex` },
	xe = { class: `w-full flex-1` },
	Se = { class: `mb-6 flex items-center justify-between` },
	Ce = { class: `flex items-center space-x-2` },
	we = { class: `text-2xl font-semibold leading-6 text-ink-gray-9` },
	Te = { class: `text-p-base text-ink-gray-7` },
	Ee = { key: 0, class: `px-4 pb-7 pt-4 sm:px-6` },
	De = { class: `space-y-2` },
	J = N(
		c({
			__name: `Dialog`,
			...
			setup(t, { emit: i }) {
				let a = t,
					...
					p = S({
						...
						set(e) {
							c(`update:modelValue`, e), e || c(`close`);
						},
					});
				function y(e) {
					p.value = e;
				...
				let T = S(() => {
						var e;
						if (!((e = a.options) != null && e.icon)) return null;
						let t = a.options.icon;
						return typeof t == `string` && (t = { name: t }), t;
					}),
					j = S(() => {
						var e, t;
						return (e = a.options) != null && e.paddingTop
							? ``
							: { center: `justify-center`, top: `pt-[20vh]` }[
									((t = a.options) == null ? void 0 : t.position) || `center`
							  ];
					}),
					N = S(() => {
						var e;
						return (e = a.options) != null && e.paddingTop
							? { paddingTop: a.options.paddingTop }
							: {};
					}),
					P = S(() => {
						var e;
						let t = (e = T.value) == null ? void 0 : e.appearance;
						return t
							? {
				...
				return (
					...
					(i, c) => (
						...
						_(
							...
							{
								open: p.value,
								"onUpdate:open": [c[3] || (c[3] = (e) => (p.value = e)), y],
							},
							{
								default: n(() => [
									A(m(ve), null, {
										default: n(() => [
											A(
												m(_e),
												{
													...
													"data-dialog": t.options.title,
													onAfterLeave:
														c[2] || (c[2] = (e) => i.$emit(`after-leave`)),
												},
												{
													default: n(() => [
														b(
															...
															[
																A(
																	...
																	{
																		class: C([
																			`my-8 inline-block w-full transform overflow-hidden rounded-xl bg-surface-modal text-start align-middle shadow-xl dialog-content focus-visible:outline-none`,
																			{
																				"max-w-7xl": t.options.size === `7xl`,
																				"max-w-6xl": t.options.size === `6xl`,
																				"max-w-5xl": t.options.size === `5xl`,
																				"max-w-4xl": t.options.size === `4xl`,
																				"max-w-3xl": t.options.size === `3xl`,
																				"max-w-2xl": t.options.size === `2xl`,
																				"max-w-xl": t.options.size === `xl`,
																				"max-w-lg":
																					t.options.size === `lg` ||
																					!t.options.size,
																				"max-w-md": t.options.size === `md`,
																				"max-w-sm": t.options.size === `sm`,
																				"max-w-xs": t.options.size === `xs`,
																			},
																		]),
																		onEscapeKeyDown:
																			c[0] || (c[0] = (e) => w()),
																		...
																		default: n(() => [
																			s(
																				...
																				() => [
																					...
																					l.value.length || i.$slots.actions
																						? (e(),
																						  d(`div`, Ee, [
																								s(
																									i.$slots,
		...
		[[`__scopeId`, `data-v-3428e46c`]]
	);
(J.Title = q), (J.Description = K);
var Oe = { class: `space-y-1.5` },
	ke = [`for`],
	Ae = [`placeholder`, `disabled`, `id`, `value`, `rows`],
	je = c({
		__name: `Textarea`,
		props: {
			size: { default: `sm` },
			...
			let a = n,
				...
				u = S(() => {
					let e = {
						...
						n = a.disabled ? `disabled` : a.variant;
					return [
						e,
						t,
						{
						...
						a.disabled ? `text-ink-gray-5` : `text-ink-gray-8`,
						`transition-colors w-full block`,
					];
				}),
				f = S(() => [
					{ sm: `text-xs`, md: `text-base`, lg: `text-lg`, xl: `text-xl` }[
						a.size
					],
					`text-ink-gray-5`,
				]),
					...
					d(`div`, Oe, [
						n.label
							? (e(),
							  d(
									`label`,
									{ key: 0, class: C([`block`, f.value]), for: n.id },
									g(n.label),
									11,
									ke
							  ))
							...
							o(
								{
									...
									value: n.modelValue,
									rows: n.rows,
									onInput: r[0] || (r[0] = (...e) => m(_) && m(_)(...e)),
									onChange: r[1] || (r[1] = (...e) => m(_) && m(_)(...e)),
								},
								m(c)
							),
							null,
...
function X(e) {
	try {
		...
		return Me.find((e) => e.urlPatterns.some((e) => t.includes(e))) || null;
	} catch (e) {
		return null;
	}
}
...
var Re = { class: `space-y-4` },
	ze = { key: 0, class: `text-red-500 text-sm mt-1` },
	Be = { key: 1, class: `text-ink-green-3 text-sm mt-1` },
	Ve = { class: `flex justify-end space-x-2` },
	He = c({
		__name: `InsertIframe`,
		props: { editor: {} },
		setup(t) {
			let r = t,
				...
				E = S(() => {
					if (!c.value) return !1;
					try {
						if (c.value.trim().startsWith(`<iframe`)) {
							let e = c.value.match(/src=["']([^"']+)["']/);
							return e != null && e[1]
								? Q(e[1], { allowedDomains: Y, HTMLAttributes: {} })
								: !1;
						}
						return Q(c.value, { allowedDomains: Y, HTMLAttributes: {} });
					} catch (e) {
						return !1;
					}
				}),
				...
				j = S(() =>
					!c.value || !E.value ? { width: 640, height: 360 } : Ne(D.value, 800)
				);
			function M() {
				(l.value = ``),
					c.value &&
						(E.value ||
							(l.value = `Please enter a supported URL or iframe embed code`));
			}
			function N() {
				(o.value = !0),
					(c.value = ``),
					...
					y(() => {
						var e;
						(e = C.value) == null || (e = e.el) == null || e.focus();
					});
			}
			S(() => {
				if (c.value && E.value) {
					let e = j.value;
					(_.value = e.width), (v.value = e.height);
				}
			});
			function P() {
				!c.value ||
					!E.value ||
					(r.editor.commands.setIframe({
						src: D.value,
						width: _.value,
						height: v.value,
						title: u.value,
						...
						? ((o.value = !1), r.editor.commands.focus())
						: (l.value = `Failed to insert embed. Please check the URL and try again.`));
			}
			function F(e) {
				var t;
				((t = e.detail) == null ? void 0 : t.editor) === r.editor && N();
			}
			return (
				i(() => {
					r.editor.view.dom.addEventListener(`iframe:open-dialog`, F);
				}),
				a(() => {
					try {
						r.editor.view.dom.removeEventListener(`iframe:open-dialog`, F);
					} catch (e) {}
				}),
				(t, r) => (
					e(),
					d(`div`, null, [
						s(t.$slots, `default`, x(k({ onClick: N }))),
						A(
							m(J),
							{
								modelValue: o.value,
								"onUpdate:modelValue": r[2] || (r[2] = (e) => (o.value = e)),
								...
								"body-content": n(() => [
									b(`div`, Re, [
										b(`div`, null, [
											...
											l.value
												? (e(), d(`p`, ze, g(l.value), 1))
												: c.value && E.value
												? (e(),
												  d(
														`p`,
														Be,
														` ✓ Valid ` + g(O.value.platform) + ` URL `,
														1
												  ))
												: h(``, !0),
										]),
...
//# sourceMappingURL=InsertIframe-Cj-6lnG4.js.map
